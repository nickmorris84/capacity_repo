...
import { useState as useState12, useMemo as useMemo3, useEffect as useEffect3, useRef as useRef4, useCallback as useCallback3 } from "react";
...
var CACHE_MAX = 48;
var keyFor = (hash, strat, vid) => hash + "|" + strat + "|" + vid;
function useStrategyViews(config, ctrl, delay = 160) {
  ...
  const runInto = (missing) => {
    for (const m of missing) {
      cacheRef.current.set(m.k, (0, import_engine.simulate)(config, { strategy: m.strat, viewIds: viewIdsFor(config, m.vid) }));
    }
...
function Ribbon({ sim, selectedWeek, onScrub }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "ribbon-wrap", children: /* @__PURE__ */ jsxs("table", { className: "ribbon", children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", {}),
        weeks.map((w) => /* @__PURE__ */ jsx("th", { className: "wk", children: w.week % 4 === 0 || w.week === weeks.length - 1 ? w.week + 1 : "" }, w.week))
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: cfg.queues.map((q) => /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("th", { scope: "row", children: q.name }),
        weeks.map((w) => {
          const st = w.queues[q.id].status;
          const marked = !!eventWeeks[w.week];
          return /* @__PURE__ */ jsx("td", { style: { padding: 0 }, children: /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "ribbon-scrub", children: [
      /* @__PURE__ */ jsxs("span", { className: "legend", children: [
        /* @__PURE__ */ jsxs("span", { children: [
          /* @__PURE__ */ jsx("span", { className: "sw", style: { background: RAG.green } }),
          "Meets SLA"
        ] }),
        /* @__PURE__ */ jsxs("span", { children: [
          /* @__PURE__ */ jsx("span", { className: "sw", style: { background: RAG.amber } }),
          "At risk"
        ] }),
        /* @__PURE__ */ jsxs("span", { children: [
          /* @__PURE__ */ jsx("span", { className: "sw", style: { background: RAG.red } }),
          "Breach"
        ] }),
        /* @__PURE__ */ jsxs("span", { children: [
          /* @__PURE__ */ jsx("span", { className: "sw", style: { background: "var(--ink)" } }),
          "Scenario event"
        ] })
      ] }),
      /* @__PURE__ */ jsx("span", { className: "spacer" }),
      Object.keys(eventWeeks).length > 0 && /* @__PURE__ */ jsx("span", { className: "legend", children: Object.entries(eventWeeks).sort((a, b) => a[0] - b[0]).map(([wk, list]) => /* @__PURE__ */ jsxs("span", { className: "pill", children: [
        "wk ",
        Number(wk) + 1,
        ": ",
...
import { useState as useState2, useEffect as useEffect2, useRef as useRef2, useLayoutEffect, useCallback as useCallback2 } from "react";
function useMeasuredWidth(fallback = 640) {
  const ref = useRef2(null);
  const [w, setW] = useState2(fallback);
  useLayoutEffect(() => {
...
function Chart({ title, hint, height = 250, children }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "chart", children: [
    /* @__PURE__ */ jsxs2("div", { className: "chart-h", children: [
      /* @__PURE__ */ jsx2("h4", { children: title }),
      hint ? /* @__PURE__ */ jsx2(Hint, { text: hint }) : null
    ] }),
    /* @__PURE__ */ jsx2("div", { className: "chart-b", ref, children: children(Math.max(280, w - 16), height) })
  ] });
}
...
function HolisticPanel({ sim }) {
  ...
  return /* @__PURE__ */ jsxs3(
    Card,
    {
      ...
      right: /* @__PURE__ */ jsx3("button", { type: "button", className: "btn sm", onClick: () => setShowAll((s) => !s), children: showAll ? "Binding weeks only" : "Show all weeks" }),
      children: [
        /* @__PURE__ */ jsxs3("div", { className: "stat-row", children: [
          /* @__PURE__ */ jsxs3("div", { className: "stat", children: [
            /* @__PURE__ */ jsx3("div", { className: "l", children: "Required FTE (final wk)" }),
            /* @__PURE__ */ jsx3("div", { className: "v", children: num(last.reqFte, 0) })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "stat", children: [
            /* @__PURE__ */ jsx3("div", { className: "l", children: "Paid FTE (final wk)" }),
            /* @__PURE__ */ jsx3("div", { className: "v", children: num(last.paid, 0) })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "stat", children: [
            /* @__PURE__ */ jsx3("div", { className: "l", children: "In pipeline (final wk)" }),
            /* @__PURE__ */ jsx3("div", { className: "v", children: num(pipeline, 0) })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "stat", children: [
            /* @__PURE__ */ jsx3("div", { className: "l", children: "Global cap" }),
            /* @__PURE__ */ jsxs3("div", { className: "v", children: [
              cap,
              /* @__PURE__ */ jsx3("small", { children: "/wk" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "stat", children: [
            /* @__PURE__ */ jsx3("div", { className: "l", children: "Cap-bound weeks" }),
            /* @__PURE__ */ jsx3("div", { className: "v", children: binding.length })
          ] })
        ] }),
        /* @__PURE__ */ jsx3("p", { className: "note", style: { marginTop: 12 }, children: binding.length ? `Feasibility: the cap allows +${cap}/wk, but this plan needs up to +${Math.round(maxWant)}/wk in week${bindingWeeks.length > 1 ? "s" : ""} ${formatWeekRange(bindingWeeks)} \u2014 infeasible. The shortfall lands as churn.` : `Feasibility: the plan fits within the +${cap}/wk cap across the whole horizon.` }),
        /* @__PURE__ */ jsx3("div", { className: "tbl-wrap", style: { marginTop: 12, maxHeight: 380 }, children: /* @__PURE__ */ jsxs3("table", { className: "data", children: [
          /* @__PURE__ */ jsx3("thead", { children: /* @__PURE__ */ jsxs3("tr", { children: [
            /* @__PURE__ */ jsx3("th", { children: "Week" }),
            /* @__PURE__ */ jsx3("th", { children: "Cap" }),
            /* @__PURE__ */ jsx3("th", { children: "Wanted" }),
            cfg.queues.map((q) => /* @__PURE__ */ jsx3("th", { children: q.name }, q.id)),
            /* @__PURE__ */ jsx3("th", { children: "Proj. churn" })
          ] }) }),
          /* @__PURE__ */ jsxs3("tbody", { children: [
            rows.map((t) => {
              const proj = t.binding ? churnForShort(t) : 0;
              return /* @__PURE__ */ jsxs3("tr", { style: t.binding ? { background: "var(--red-s)" } : void 0, children: [
                /* @__PURE__ */ jsx3("td", { children: t.week + 1 }),
                /* @__PURE__ */ jsx3("td", { children: t.cap == null ? "\u221E" : t.cap }),
                ...
                cfg.queues.map((q) => {
                  ...
                  return /* @__PURE__ */ jsxs3("td", { className: d > 0.05 ? "st-red" : void 0, children: [
                    g > 0.05 ? num(g, 0) : "\u2013",
                    d > 0.05 ? ` (\u2212${num(d, 0)})` : ""
                  ] }, q.id);
                }),
                /* @__PURE__ */ jsx3("td", { children: proj > 0 ? money(cur, proj) : "\u2013" })
              ] }, t.week);
            }),
            rows.length === 0 && /* @__PURE__ */ jsx3("tr", { children: /* @__PURE__ */ jsx3("td", { colSpan: 4 + cfg.queues.length, className: "empty", children: "No allocation activity." }) })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx3("p", { className: "note", style: { marginTop: 10 }, children: "When the cap binds, scarce requisitions go to the queue with the greatest marginal churn cost averted per FTE (tie-break: earliest projected breach). A number in brackets is the shortfall that queue was denied that week." })
      ]
    }
  );
}
...
function markLine(selectedWeek) {
  ...
  return /* @__PURE__ */ jsx4(ReferenceLine, { x: selectedWeek + 1, stroke: "#0f1720", strokeDasharray: "3 3", strokeOpacity: 0.5 });
}
function CoverageChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Coverage vs 100%", hint: "Available productive hours \xF7 required hours, laid along the requirement curve. 100% means SLA is met in every interval; below is a uniform shortfall.", children: (w, h) => /* @__PURE__ */ jsxs4(LineChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 40, domain: [0, "auto"], tickFormatter: (v) => v + "%" }),
    /* @__PURE__ */ jsx4(Tooltip, { formatter: (v) => v + "%" }),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    /* @__PURE__ */ jsx4(ReferenceLine, { y: 100, stroke: "#1f9d55", strokeDasharray: "4 2" }),
    markLine(selectedWeek),
    cfg.queues.map((q, i) => /* @__PURE__ */ jsx4(Line, { type: "monotone", dataKey: q.id, name: q.name, stroke: SERIES[i % SERIES.length], dot: false, strokeWidth: 2, isAnimationActive: false }, q.id))
  ] }) });
}
function HeadcountChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Headcount \u2014 trained / ramping / training vs required", hint: "Paid heads split by readiness. Trainees cost full salary but deliver zero; ramping agents deliver their learning-curve share. The line is required FTE.", children: (w, h) => /* @__PURE__ */ jsxs4(ComposedChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 40 }),
    /* @__PURE__ */ jsx4(Tooltip, {}),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    /* @__PURE__ */ jsx4(Area, { type: "monotone", dataKey: "trained", stackId: "hc", stroke: "#0e7c86", fill: "#0e7c86", fillOpacity: 0.75, isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Area, { type: "monotone", dataKey: "ramping", stackId: "hc", stroke: "#12a3b0", fill: "#57c3cc", fillOpacity: 0.7, isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Area, { type: "monotone", dataKey: "training", stackId: "hc", stroke: "#d98a0b", fill: "#f0c774", fillOpacity: 0.7, isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Line, { type: "monotone", dataKey: "required", stroke: "#0f1720", strokeWidth: 2, dot: false, isAnimationActive: false }),
    markLine(selectedWeek)
  ] }) });
}
function VolumeChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Volume composition", hint: "Exogenous base volume (after seasonality and scenarios) plus endogenous load: digital\u2192voice deflection and abandoned-caller redials.", children: (w, h) => /* @__PURE__ */ jsxs4(BarChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 48, tickFormatter: (v) => v >= 1e3 ? (v / 1e3).toFixed(0) + "k" : v }),
    /* @__PURE__ */ jsx4(Tooltip, {}),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "base", name: "Base", stackId: "v", fill: "#0e7c86", isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "deflected", name: "Deflected", stackId: "v", fill: "#5a54c9", isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "redial", name: "Redial", stackId: "v", fill: "#d98a0b", isAnimationActive: false }),
    markLine(selectedWeek)
  ] }) });
}
function CostChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Cost breakdown", hint: "Weekly run cost by component: productive salary, trainee salary, management overhead, and service-team premium hours.", children: (w, h) => /* @__PURE__ */ jsxs4(BarChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 48, tickFormatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx4(Tooltip, { formatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "productive", name: "Productive", stackId: "c", fill: "#0e7c86", isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "training", name: "Training", stackId: "c", fill: "#d98a0b", isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "managers", name: "Managers", stackId: "c", fill: "#5a54c9", isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Bar, { dataKey: "service", name: "Service team", stackId: "c", fill: "#2f8f4e", isAnimationActive: false }),
    markLine(selectedWeek)
  ] }) });
}
function IdleChurnChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Idle pay vs churn cost", hint: "Over-staffing wastes salary; under-staffing loses customers. The break-even week is where the two curves cross \u2014 the cheapest place to sit.", children: (w, h) => /* @__PURE__ */ jsxs4(LineChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 48, tickFormatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx4(Tooltip, { formatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    /* @__PURE__ */ jsx4(Line, { type: "monotone", dataKey: "idle", name: "Idle pay", stroke: "#3a7bd5", strokeWidth: 2, dot: false, isAnimationActive: false }),
    /* @__PURE__ */ jsx4(Line, { type: "monotone", dataKey: "churn", name: "Churn cost", stroke: "#c0417a", strokeWidth: 2, dot: false, isAnimationActive: false }),
    cross != null && /* @__PURE__ */ jsx4(ReferenceLine, { x: cross, stroke: "#1f9d55", label: { value: "break-even", fontSize: 10, fill: "#1f9d55", position: "top" } }),
    markLine(selectedWeek)
  ] }) });
}
function BurnoutChart({ sim, selectedWeek }) {
  ...
  return /* @__PURE__ */ jsx4(Chart, { title: "Burnout index", hint: "Accumulates while occupancy exceeds the threshold, multiplying attrition and adding absence shrinkage; recovers when occupancy eases.", children: (w, h) => /* @__PURE__ */ jsxs4(LineChart, { width: w, height: h, data, ...common, children: [
    /* @__PURE__ */ jsx4(CartesianGrid, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx4(XAxis, { ...wkX }),
    /* @__PURE__ */ jsx4(YAxis, { tick: AX, width: 36, domain: [0, 100] }),
    /* @__PURE__ */ jsx4(Tooltip, {}),
    /* @__PURE__ */ jsx4(Legend, { wrapperStyle: { fontSize: 11 } }),
    cfg.queues.map((q, i) => /* @__PURE__ */ jsx4(Line, { type: "monotone", dataKey: q.id, name: q.name, stroke: SERIES[i % SERIES.length], dot: false, strokeWidth: 2, isAnimationActive: false }, q.id)),
    markLine(selectedWeek)
...
function Findings({ findings }) {
  if (!findings || !findings.length) return /* @__PURE__ */ jsx5("div", { className: "empty", children: "No findings \u2014 the plan holds across the horizon." });
  return /* @__PURE__ */ jsx5("div", { className: "findings", children: findings.map((f, i) => /* @__PURE__ */ jsxs5("div", { className: "finding " + f.tone, children: [
...
function QueueCard({ q, s }) {
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "qcard " + s.status, children: [
    /* @__PURE__ */ jsxs5("div", { className: "qn", children: [
      /* @__PURE__ */ jsx5("span", { children: q.name }),
      /* @__PURE__ */ jsx5("span", { className: "spacer" }),
      /* @__PURE__ */ jsx5("span", { className: "qtype", children: q.type })
    ] }),
    /* @__PURE__ */ jsxs5("div", { className: "kpis", children: [
      /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
        /* @__PURE__ */ jsx5("div", { className: "l", children: "Coverage" }),
        /* @__PURE__ */ jsx5("div", { className: "v", children: pct(s.cover) })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
        /* @__PURE__ */ jsx5("div", { className: "l", children: "Status" }),
        /* @__PURE__ */ jsx5("div", { className: "v", children: /* @__PURE__ */ jsx5("span", { className: "badge " + s.status, children: s.status }) })
      ] }),
      voice ? /* @__PURE__ */ jsxs5(Fragment2, { children: [
        /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
          /* @__PURE__ */ jsx5("div", { className: "l", children: "ASA" }),
          /* @__PURE__ */ jsx5("div", { className: "v", children: secs(s.asa) })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
          /* @__PURE__ */ jsx5("div", { className: "l", children: "Abandon" }),
          /* @__PURE__ */ jsx5("div", { className: "v", children: pct(s.abandon, 1) })
        ] })
      ] }) : /* @__PURE__ */ jsxs5(Fragment2, { children: [
        /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
          /* @__PURE__ */ jsx5("div", { className: "l", children: "Response" }),
          /* @__PURE__ */ jsxs5("div", { className: "v", children: [
            num(s.respMin, 1),
            "m"
          ] })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
          /* @__PURE__ */ jsx5("div", { className: "l", children: "In SLA" }),
          /* @__PURE__ */ jsx5("div", { className: "v", children: pct(s.sl) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
        /* @__PURE__ */ jsx5("div", { className: "l", children: "Occupancy" }),
        /* @__PURE__ */ jsx5("div", { className: "v", children: pct(s.occ) })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "kpi", children: [
        /* @__PURE__ */ jsx5("div", { className: "l", children: "Paid / req" }),
        /* @__PURE__ */ jsxs5("div", { className: "v", children: [
          num(s.paid, 0),
          "/",
          num(s.reqFte, 0)
...
function PlanTab({ sim, viewLabel }) {
  const cfg = sim.config;
  const [selectedWeek, setSelectedWeek] = useState4(0);
  ...
  return /* @__PURE__ */ jsxs5(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx5(Card, { title: "Findings", hint: "Auto-written from the active strategy. Red demands a decision; amber is a watch item.", children: /* @__PURE__ */ jsx5(Findings, { findings: sm.findings }) }),
        /* @__PURE__ */ jsx5(
          Card,
          {
            title: "RAG ribbon",
            ...
            children: /* @__PURE__ */ jsx5(Ribbon, { sim, selectedWeek: wk, onScrub: setSelectedWeek })
          }
        ),
        /* @__PURE__ */ jsxs5(Card, { title: `Queue status \u2014 week ${wk + 1}`, sub: `${sm.strategy} active \xB7 view: ${viewLabel || "Plan of record"}`, children: [
          /* @__PURE__ */ jsx5("div", { className: "qcards", children: cfg.queues.map((q) => /* @__PURE__ */ jsx5(QueueCard, { q, s: week.queues[q.id] }, q.id)) }),
          /* @__PURE__ */ jsx5("hr", { className: "sep", style: { margin: "14px 0" } }),
          /* @__PURE__ */ jsxs5("div", { className: "stat-row", children: [
            /* @__PURE__ */ jsxs5("div", { className: "stat", children: [
              /* @__PURE__ */ jsx5("div", { className: "l", children: "Week run cost" }),
              /* @__PURE__ */ jsx5("div", { className: "v", children: money(cur, week.totals.totalCost) })
            ] }),
            /* @__PURE__ */ jsxs5("div", { className: "stat", children: [
              /* @__PURE__ */ jsx5("div", { className: "l", children: "Week churn cost" }),
              /* @__PURE__ */ jsx5("div", { className: "v", children: money(cur, week.totals.churnCost) })
            ] }),
            /* @__PURE__ */ jsxs5("div", { className: "stat", children: [
              /* @__PURE__ */ jsx5("div", { className: "l", children: "Paid FTE" }),
              /* @__PURE__ */ jsxs5("div", { className: "v", children: [
                num(week.totals.paid, 0),
                " ",
            ...
            /* @__PURE__ */ jsxs5("div", { className: "stat", children: [
              /* @__PURE__ */ jsx5("div", { className: "l", children: "Horizon all-in" }),
              /* @__PURE__ */ jsx5("div", { className: "v", children: money(cur, sm.allIn) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "grid cols-2", children: [
          /* @__PURE__ */ jsx5(CoverageChart, { sim, selectedWeek: wk }),
          /* @__PURE__ */ jsx5(HeadcountChart, { sim, selectedWeek: wk }),
          /* @__PURE__ */ jsx5(VolumeChart, { sim, selectedWeek: wk }),
          /* @__PURE__ */ jsx5(CostChart, { sim, selectedWeek: wk }),
          /* @__PURE__ */ jsx5(IdleChurnChart, { sim, selectedWeek: wk }),
          /* @__PURE__ */ jsx5(BurnoutChart, { sim, selectedWeek: wk })
        ] }),
        /* @__PURE__ */ jsx5(HolisticPanel, { sim })
      ]
    }
  );
}
...
import { BarChart as BarChart2, Bar as Bar2, ComposedChart as ComposedChart2, Line as Line2, XAxis as XAxis2, YAxis as YAxis2, CartesianGrid as CartesianGrid2, Tooltip as Tooltip2, Legend as Legend2 } from "recharts";
import { Fragment as Fragment3, jsx as jsx6, jsxs as jsxs6 } from "react/jsx-runtime";
function IntradayTab({ sim }) {
  const cfg = sim.config;
  const eng = cfg.engine;
  const [qid, setQid] = useState5(cfg.queues[0] ? cfg.queues[0].id : "");
  const [wk, setWk] = useState5(0);
  const q = cfg.queues.find((x) => x.id === qid) || cfg.queues[0];
  if (!q) return /* @__PURE__ */ jsx6("div", { className: "empty", children: "No queues configured." });
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "grid", style: { gap: 16 }, children: [
    /* @__PURE__ */ jsx6(Card, { title: "Intraday view", sub: "first day of the selected week", children: /* @__PURE__ */ jsxs6("div", { className: "fieldrow", style: { maxWidth: 520 }, children: [
      /* @__PURE__ */ jsx6(
        SelectField,
        {
          label: "Queue",
    ...
    /* @__PURE__ */ jsx6(Chart, { title: `Required vs available agents \u2014 ${q.name}`, hint: "Available agent-hours are laid along the requirement curve (engineering note E2), so quiet intervals still receive proportionally more agents. Bars are required; the line is available.", children: (w, h) => /* @__PURE__ */ jsxs6(ComposedChart2, { width: w, height: h, data, margin: { top: 8, right: 14, left: 4, bottom: 4 }, children: [
      /* @__PURE__ */ jsx6(CartesianGrid2, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
      /* @__PURE__ */ jsx6(XAxis2, { dataKey: "t", tick: { fontSize: 10 }, interval: "preserveStartEnd", minTickGap: 16 }),
      /* @__PURE__ */ jsx6(YAxis2, { tick: { fontSize: 11 }, width: 40 }),
      /* @__PURE__ */ jsx6(Tooltip2, {}),
      /* @__PURE__ */ jsx6(Legend2, { wrapperStyle: { fontSize: 11 } }),
      /* @__PURE__ */ jsx6(Bar2, { dataKey: "required", name: "Required agents", fill: "#0e7c86", isAnimationActive: false }),
      /* @__PURE__ */ jsx6(Line2, { type: "monotone", dataKey: "available", name: "Available agents", stroke: "#d98a0b", strokeWidth: 2, dot: false, isAnimationActive: false })
    ] }) }),
    /* @__PURE__ */ jsx6(Card, { title: "Interval detail", sub: `${q.name} \xB7 week ${Math.min(wk, sim.weeks.length - 1) + 1}`, children: /* @__PURE__ */ jsx6("div", { className: "tbl-wrap", style: { maxHeight: 460 }, children: /* @__PURE__ */ jsxs6("table", { className: "data", children: [
      /* @__PURE__ */ jsx6("thead", { children: /* @__PURE__ */ jsxs6("tr", { children: [
        /* @__PURE__ */ jsx6("th", { children: "Interval" }),
        /* @__PURE__ */ jsx6("th", { children: "Arrivals" }),
        /* @__PURE__ */ jsx6("th", { children: "Required" }),
        /* @__PURE__ */ jsx6("th", { children: "Available" }),
        voice ? /* @__PURE__ */ jsxs6(Fragment3, { children: [
          /* @__PURE__ */ jsx6("th", { children: "ASA" }),
          /* @__PURE__ */ jsx6("th", { children: "Abandon" }),
          /* @__PURE__ */ jsx6("th", { children: "SL" })
        ] }) : /* @__PURE__ */ jsxs6(Fragment3, { children: [
          /* @__PURE__ */ jsx6("th", { children: "Backlog" }),
          /* @__PURE__ */ jsx6("th", { children: "Response" }),
          /* @__PURE__ */ jsx6("th", { children: "Served" })
        ] }),
        /* @__PURE__ */ jsx6("th", { children: "Occupancy" })
      ] }) }),
      /* @__PURE__ */ jsxs6("tbody", { children: [
        byInterval.map((iv) => /* @__PURE__ */ jsxs6("tr", { children: [
          /* @__PURE__ */ jsx6("td", { children: intervalLabel(iv.i, eng) }),
          /* @__PURE__ */ jsx6("td", { children: Math.round(iv.arrivals) }),
          /* @__PURE__ */ jsx6("td", { children: num(iv.req, 1) }),
          /* @__PURE__ */ jsx6("td", { children: num(iv.agents, 1) }),
          voice ? /* @__PURE__ */ jsxs6(Fragment3, { children: [
            /* @__PURE__ */ jsx6("td", { children: secs(iv.asa) }),
            /* @__PURE__ */ jsx6("td", { children: pct(iv.abandon, 1) }),
            /* @__PURE__ */ jsx6("td", { children: pct(iv.sl) })
          ] }) : /* @__PURE__ */ jsxs6(Fragment3, { children: [
            /* @__PURE__ */ jsx6("td", { children: num(iv.backlog, 0) }),
            /* @__PURE__ */ jsxs6("td", { children: [
              num(iv.resp || 0, 1),
              "m"
            ] }),
            /* @__PURE__ */ jsx6("td", { children: num(iv.served || 0, 0) })
          ] }),
          /* @__PURE__ */ jsx6("td", { children: pct(iv.occ) })
        ] }, iv.i)),
        byInterval.length === 0 && /* @__PURE__ */ jsx6("tr", { children: /* @__PURE__ */ jsx6("td", { colSpan: 8, className: "empty", children: "No intraday detail for this selection." }) })
      ] })
    ] }) }) })
  ] });
}

// ui/components/ComparisonChart.jsx
import { LineChart as LineChart2, Line as Line3, XAxis as XAxis3, YAxis as YAxis3, CartesianGrid as CartesianGrid3, Tooltip as Tooltip3, Legend as Legend3 } from "recharts";
import { jsx as jsx7, jsxs as jsxs7 } from "react/jsx-runtime";
var SERIES2 = ["#0e7c86", "#d98a0b", "#5a54c9", "#c0417a", "#2f8f4e", "#b0602a", "#3a7bd5", "#8a51b0"];
function ComparisonChart({ series, currency, title, hint }) {
  ...
  return /* @__PURE__ */ jsx7("div", { "data-testid": "comparison-chart", "data-series": live.length, children: /* @__PURE__ */ jsx7(Chart, { title, hint, height: 280, children: (w, h) => /* @__PURE__ */ jsxs7(LineChart2, { width: w, height: h, data, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
    /* @__PURE__ */ jsx7(CartesianGrid3, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx7(XAxis3, { dataKey: "wk", tick: { fontSize: 11 }, interval: "preserveStartEnd", minTickGap: 18 }),
    /* @__PURE__ */ jsx7(YAxis3, { tick: { fontSize: 11 }, width: 52, tickFormatter: (v) => money(currency, v) }),
    /* @__PURE__ */ jsx7(Tooltip3, { formatter: (v) => money(currency, v) }),
    /* @__PURE__ */ jsx7(Legend3, { wrapperStyle: { fontSize: 11 } }),
    live.map((s, i) => /* @__PURE__ */ jsx7(Line3, { type: "monotone", dataKey: s.key, name: s.name, stroke: SERIES2[i % SERIES2.length], strokeWidth: 2, dot: false, isAnimationActive: false }, s.key))
  ] }) }) });
}
...
function ComparisonTable({ strategySims, activeStrategy, onActivate, currency }) {
  ...
  return /* @__PURE__ */ jsx8("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs8("table", { className: "data", children: [
    /* @__PURE__ */ jsx8("thead", { children: /* @__PURE__ */ jsxs8("tr", { children: [
      /* @__PURE__ */ jsx8("th", { children: "Strategy" }),
      /* @__PURE__ */ jsx8("th", { children: "Red weeks" }),
      /* @__PURE__ */ jsx8("th", { children: "End HC" }),
      /* @__PURE__ */ jsx8("th", { children: "Run cost" }),
      /* @__PURE__ */ jsx8("th", { children: "Churn" }),
      /* @__PURE__ */ jsx8("th", { children: "All-in" }),
      /* @__PURE__ */ jsx8("th", { children: "Feasibility" }),
      /* @__PURE__ */ jsx8("th", {})
    ] }) }),
    /* @__PURE__ */ jsx8("tbody", { children: STRATEGIES.map((strat) => {
      const s = statsById[strat.id];
      if (!s) return /* @__PURE__ */ jsxs8("tr", { children: [
        /* @__PURE__ */ jsx8("td", { children: strat.id }),
        /* @__PURE__ */ jsx8("td", { colSpan: 7, className: "empty", children: "computing\u2026" })
      ] }, strat.id);
      const isActive = strat.id === activeStrategy;
      const isRec = strat.id === recommended;
      return /* @__PURE__ */ jsxs8("tr", { style: isActive ? { background: "rgba(14,124,134,.08)" } : void 0, children: [
        /* @__PURE__ */ jsxs8("td", { children: [
          /* @__PURE__ */ jsx8("strong", { children: strat.id }),
          " ",
          strat.name,
          isActive ? /* @__PURE__ */ jsx8("span", { className: "tag", style: { marginLeft: 6 }, children: "active" }) : null,
          isRec ? /* @__PURE__ */ jsx8("span", { className: "tag soft", style: { marginLeft: 6 }, children: "recommended" }) : null
        ] }),
        /* @__PURE__ */ jsx8("td", { className: s.redWeeks > 0 ? "st-red" : "st-green", children: s.redWeeks }),
        /* @__PURE__ */ jsx8("td", { children: num(s.endHC, 0) }),
        /* @__PURE__ */ jsx8("td", { children: money(currency, s.runCost) }),
        /* @__PURE__ */ jsx8("td", { children: money(currency, s.churn) }),
        /* @__PURE__ */ jsx8("td", { children: /* @__PURE__ */ jsx8("strong", { children: money(currency, s.allIn) }) }),
        /* @__PURE__ */ jsx8("td", { className: s.feasible ? "st-green" : "st-red", children: s.feasible ? "Feasible" : s.flags.capInfeasible ? "Cap-bound" : s.flags.tippingPoint ? "Tipping point" : "Breaches SLA" }),
        /* @__PURE__ */ jsx8("td", { children: /* @__PURE__ */ jsx8("button", { type: "button", className: "btn sm" + (isActive ? " primary" : ""), disabled: isActive, onClick: () => onActivate(strat.id), children: isActive ? "Active" : "Make active" }) })
      ] }, strat.id);
    }) })
  ] }) });
}
function StrategiesTab({ simSet, config, activeStrategy, activeViewId, onActivateStrategy, comparison, setComparison }) {
  ...
  if (dimension === "strategies") {
    series = STRATEGIES.map((strat) => ({ key: strat.id, name: `${strat.id} \xB7 ${strat.name}`, sim: strategySims[strat.id] }));
  ...
  const toggleOverlayView = (vid) => {
    setComparison((c) => {
      ...
      if (c.overlayViewIds.length >= MAX_OVERLAY) return c;
  ...
  return /* @__PURE__ */ jsxs8(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx8(Card, { title: "Strategy comparison", sub: `active view: ${viewName(config, activeViewId)}`, hint: "All four strategies are re-run on every change. The active strategy drives every other tab.", children: /* @__PURE__ */ jsx8(ComparisonTable, { strategySims, activeStrategy, onActivate: onActivateStrategy, currency: cur }) }),
        /* @__PURE__ */ jsxs8(
          Card,
          {
            ...
            right: /* @__PURE__ */ jsxs8("div", { className: "btnbar", role: "group", "aria-label": "Comparison dimension", children: [
              /* @__PURE__ */ jsx8(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsx8(
                "button",
                {
                  ...
                  children: "Compare views"
                }
              )
            ] }),
            children: [
              dimension === "views" && /* @__PURE__ */ jsxs8("div", { className: "rowflex", style: { marginBottom: 12 }, children: [
                /* @__PURE__ */ jsxs8("span", { className: "lab", style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                  "Overlay views ",
                  /* @__PURE__ */ jsx8(Hint, { text: "Pick up to four scenario views to overlay for the active strategy." })
                ] }),
                config.views.map((v) => {
                  const on = overlayViewIds.includes(v.id);
                  const disabled = !on && overlayViewIds.length >= MAX_OVERLAY;
                  return /* @__PURE__ */ jsxs8("label", { className: "switch", style: disabled ? { opacity: 0.5 } : void 0, children: [
                    /* @__PURE__ */ jsx8("input", { type: "checkbox", checked: on, disabled, onChange: () => toggleOverlayView(v.id) }),
                    /* @__PURE__ */ jsx8("span", { className: "track", "aria-hidden": "true" }),
                    /* @__PURE__ */ jsx8("span", { children: v.name })
                  ] }, v.id);
                }),
                /* @__PURE__ */ jsxs8("span", { className: "pill", children: [
                  overlayViewIds.length,
                  "/",
                  MAX_OVERLAY
                ] })
              ] }),
              /* @__PURE__ */ jsx8(ComparisonChart, { series, currency: cur, title: chartTitle, hint: chartHint })
            ]
          }
        ),
        activeSim && /* @__PURE__ */ jsx8(HolisticPanel, { sim: activeSim })
      ]
    }
  );
}
...
function DataTab({ sim, config, activeViewId, views, onSelectView }) {
  const [qid, setQid] = useState6(config.queues[0] ? config.queues[0].id : "");
  const [hidden, setHidden] = useState6(() => /* @__PURE__ */ new Set());
  const queue = config.queues.find((q) => q.id === qid) || config.queues[0];
  if (!queue) return /* @__PURE__ */ jsx9("div", { className: "empty", children: "No queues configured." });
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "grid", style: { gap: 16 }, children: [
    /* @__PURE__ */ jsxs9(Card, { title: "Per-queue data", hint: "Every weekly datapoint \u2014 outputs and the assumptions in effect that week. Read-only: edit values in the editor tabs.", children: [
      /* @__PURE__ */ jsxs9("div", { className: "fieldrow", style: { maxWidth: 640 }, children: [
        /* @__PURE__ */ jsx9(SelectField, { label: "Queue", value: queue.id, onChange: setQid, options: config.queues.map((q) => ({ value: q.id, label: q.name })) }),
        /* @__PURE__ */ jsx9(SelectField, { label: "View", value: activeViewId, onChange: onSelectView, options: views.map((v) => ({ value: v.id, label: v.name })) })
      ] }),
      /* @__PURE__ */ jsxs9("div", { className: "rowflex", style: { marginTop: 12 }, children: [
        /* @__PURE__ */ jsxs9("span", { className: "lab", style: { display: "flex", alignItems: "center", gap: 6 }, children: [
          "Column groups ",
          /* @__PURE__ */ jsx9(Hint, { text: "Toggle groups of columns. All are on by default." })
        ] }),
        COLUMN_GROUPS.filter((g) => g !== "Week").map((g) => /* @__PURE__ */ jsxs9("label", { className: "switch", children: [
          /* @__PURE__ */ jsx9("input", { type: "checkbox", checked: !hidden.has(g), onChange: () => toggleGroup(g) }),
          /* @__PURE__ */ jsx9("span", { className: "track", "aria-hidden": "true" }),
          /* @__PURE__ */ jsx9("span", { children: g })
        ] }, g)),
    ...
    /* @__PURE__ */ jsx9(Card, { title: `${queue.name} \u2014 weekly`, sub: `${rows.length} weeks \xB7 ${cols.length} columns`, children: /* @__PURE__ */ jsx9("div", { className: "tbl-wrap", style: { maxHeight: 560 }, children: /* @__PURE__ */ jsxs9("table", { className: "data", "data-testid": "data-table", children: [
      /* @__PURE__ */ jsx9("thead", { children: /* @__PURE__ */ jsx9("tr", { children: cols.map((c) => /* @__PURE__ */ jsx9("th", { children: c.label }, c.key)) }) }),
      /* @__PURE__ */ jsx9("tbody", { children: rows.map((row) => /* @__PURE__ */ jsx9("tr", { children: cols.map((c) => /* @__PURE__ */ jsx9("td", { className: c.key === "status" ? "st-" + row.status : void 0, children: c.fmt(row[c.key]) }, c.key)) }, row.week)) })
    ] }) }) })
  ] });
}
...
var Stat = ({ l, v, sub }) => /* @__PURE__ */ jsxs10("div", { className: "stat", children: [
  /* @__PURE__ */ jsx10("div", { className: "l", children: l }),
  /* @__PURE__ */ jsxs10("div", { className: "v", children: [
    v,
    sub ? /* @__PURE__ */ jsxs10("small", { children: [
      " ",
      sub
    ] }) : null
  ] })
] });
function SummaryTab({ sim, strategySims, config, activeStrategy, activeViewId }) {
  const cur = config.engine.currency;
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "grid", style: { gap: 16 }, children: [
    /* @__PURE__ */ jsxs10(Card, { title: "Verdict", sub: `${strategyName(activeStrategy)} \xB7 ${viewName(config, activeViewId)}`, hint: "Auto-written from the active strategy and view. The recommendation is the lowest all-in cost that holds SLA, or the least-bad option if none does.", children: [
      /* @__PURE__ */ jsx10("p", { style: { margin: "0 0 12px", fontSize: 14, lineHeight: 1.55 }, children: verdict.paragraph }),
      /* @__PURE__ */ jsxs10("div", { className: "stat-row", children: [
        /* @__PURE__ */ jsx10(Stat, { l: "Meets SLA", v: verdict.rag.green, sub: "queue-wks" }),
        /* @__PURE__ */ jsx10(Stat, { l: "At risk", v: verdict.rag.amber, sub: "queue-wks" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Breach", v: verdict.rag.red, sub: "queue-wks" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Recommended", v: verdict.recommended || "\u2013" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs10("div", { className: "grid cols-3", children: [
      /* @__PURE__ */ jsx10(Card, { title: "Finance", hint: "The money view: what it costs to run and what poor experience costs on top.", children: /* @__PURE__ */ jsxs10("div", { className: "stat-row", style: { flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ jsx10(Stat, { l: "Run cost", v: money(cur, f.runCost) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Churn cost", v: money(cur, f.churn) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Idle pay", v: money(cur, f.idle) }),
        /* @__PURE__ */ jsx10(Stat, { l: "All-in", v: money(cur, f.allIn) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Cost / contact", v: moneyFull(cur, f.costPerContact) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Break-even week", v: f.breakEven ?? "\u2013" })
      ] }) }),
      /* @__PURE__ */ jsx10(Card, { title: "HR", hint: "The people view: hiring against the cap, and the attrition/burnout trajectory.", children: /* @__PURE__ */ jsxs10("div", { className: "stat-row", style: { flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ jsx10(Stat, { l: "Total reqs raised", v: num(hr.totalReqs, 0) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Global cap", v: hr.cap, sub: "/wk" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Avg leavers", v: num(hr.avgLeavers, 1), sub: "/wk" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Tipping margin", v: num(hr.tippingMargin, 1), sub: hr.tippingPoint ? "\xB7 tipped" : "/wk" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Peak burnout", v: num(hr.peakBurn, 0) + "/100" }),
        /* @__PURE__ */ jsx10(Stat, { l: "Avg in training", v: num(hr.avgTraining, 1) })
      ] }) }),
      /* @__PURE__ */ jsx10(Card, { title: "Business / CX", hint: "The customer view: SLA attainment, lost customers, incident readiness and deflection.", children: /* @__PURE__ */ jsxs10("div", { className: "stat-row", style: { flexDirection: "column", gap: 12 }, children: [
        /* @__PURE__ */ jsx10(Stat, { l: "Customers lost", v: num(bz.customersLost, 0) }),
        /* @__PURE__ */ jsx10(Stat, { l: "Deflected \u2192 voice", v: num(bz.totalDeflected, 0) }),
        /* @__PURE__ */ jsx10(Stat, { l: "P1 stress in view", v: bz.p1Enabled ? "yes" : "no" }),
        /* @__PURE__ */ jsxs10("div", { children: [
          /* @__PURE__ */ jsx10("div", { className: "l", style: { fontSize: 11, color: "var(--muted)", marginBottom: 4 }, children: "SLA attainment by queue" }),
          bz.perQueueSla.map((s) => /* @__PURE__ */ jsxs10("div", { className: "rowflex", style: { justifyContent: "space-between", fontSize: 12 }, children: [
            /* @__PURE__ */ jsx10("span", { children: s.name }),
            /* @__PURE__ */ jsx10("strong", { children: pct(s.attainment) })
          ] }, s.name))
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx10(Card, { title: "Risk register", sub: `${risks.length} risk(s)`, hint: "Auto-generated and sortable. Severity is the projected \xA3 (or SLA weeks) at stake; the lever is the cheapest mitigation.", children: /* @__PURE__ */ jsx10("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs10("table", { className: "data", "data-testid": "risk-table", children: [
      /* @__PURE__ */ jsx10("thead", { children: /* @__PURE__ */ jsxs10("tr", { children: [
        /* @__PURE__ */ jsxs10("th", { style: { cursor: "pointer" }, onClick: () => setSortKey("risk"), children: [
          "Risk",
          arrow("risk")
        ] }),
        /* @__PURE__ */ jsx10("th", { children: "Driver" }),
        /* @__PURE__ */ jsxs10("th", { style: { cursor: "pointer" }, onClick: () => setSortKey("week"), children: [
          "Week",
          arrow("week")
        ] }),
        /* @__PURE__ */ jsxs10("th", { style: { cursor: "pointer" }, onClick: () => setSortKey("severityValue"), children: [
          "Severity",
          arrow("severityValue")
        ] }),
        /* @__PURE__ */ jsx10("th", { children: "SLA impact" }),
        /* @__PURE__ */ jsx10("th", { children: "Suggested lever" })
      ] }) }),
      /* @__PURE__ */ jsxs10("tbody", { children: [
        sortedRisks.map((r, i) => /* @__PURE__ */ jsxs10("tr", { children: [
          /* @__PURE__ */ jsx10("td", { style: { textAlign: "left", fontWeight: 600 }, children: r.risk }),
          /* @__PURE__ */ jsx10("td", { style: { textAlign: "left", whiteSpace: "normal", maxWidth: 280 }, children: r.driver }),
          /* @__PURE__ */ jsx10("td", { children: r.week ?? "\u2013" }),
          /* @__PURE__ */ jsx10("td", { children: r.severityMoney != null ? money(cur, r.severityMoney) : "\u2014" }),
          /* @__PURE__ */ jsx10("td", { style: { textAlign: "left" }, children: r.sla || "\u2013" }),
          /* @__PURE__ */ jsx10("td", { style: { textAlign: "left", whiteSpace: "normal", maxWidth: 240 }, children: r.lever })
        ] }, i)),
        sortedRisks.length === 0 && /* @__PURE__ */ jsx10("tr", { children: /* @__PURE__ */ jsx10("td", { colSpan: 6, className: "empty", children: "No material risks \u2014 the plan holds across the horizon." }) })
      ] })
    ] }) }) })
  ] });
}

// ui/components/ReportTab.jsx
import {
  LineChart as LineChart3,
  Line as Line4,
  ComposedChart as ComposedChart3,
  Area as Area2,
  XAxis as XAxis4,
  YAxis as YAxis4,
...
function AllInChart({ strategySims, cur }) {
  const live = STRATEGIES.filter((s) => strategySims[s.id]).map((s) => ({ id: s.id, name: `${s.id} \xB7 ${s.name}`, sim: strategySims[s.id] }));
  const len = live.reduce((m, s) => Math.max(m, s.sim.weeks.length), 0);
  ...
  for (let w = 0; w < len; w++) {
    ...
    live.forEach((s) => {
      let c = 0;
      for (let i = 0; i <= w && i < s.sim.weeks.length; i++) c += s.sim.weeks[i].totals.allInCost;
      row[s.id] = Math.round(c);
    });
    data.push(row);
  }
  return /* @__PURE__ */ jsx11("div", { className: "report-chart", "data-testid": "report-chart", "data-fixed-width": RW, children: /* @__PURE__ */ jsxs11(LineChart3, { width: RW, height: RH, data, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
    /* @__PURE__ */ jsx11(CartesianGrid4, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx11(XAxis4, { dataKey: "wk", tick: { fontSize: 11 }, interval: "preserveStartEnd", minTickGap: 18 }),
    /* @__PURE__ */ jsx11(YAxis4, { tick: { fontSize: 11 }, width: 52, tickFormatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx11(Tooltip4, { formatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx11(Legend4, { wrapperStyle: { fontSize: 11 } }),
    live.map((s, i) => /* @__PURE__ */ jsx11(Line4, { type: "monotone", dataKey: s.id, name: s.name, stroke: colors[i % colors.length], dot: false, strokeWidth: 2, isAnimationActive: false }, s.id))
  ] }) });
}
function QueueCharts({ sim, queue }) {
  ...
  return /* @__PURE__ */ jsxs11(Fragment4, { children: [
    /* @__PURE__ */ jsx11("div", { className: "report-chart", "data-testid": "report-chart", "data-fixed-width": RW, children: /* @__PURE__ */ jsxs11(LineChart3, { width: RW, height: RH, data: cover, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
      /* @__PURE__ */ jsx11(CartesianGrid4, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
      /* @__PURE__ */ jsx11(XAxis4, { dataKey: "wk", tick: { fontSize: 11 }, interval: "preserveStartEnd", minTickGap: 18 }),
      /* @__PURE__ */ jsx11(YAxis4, { tick: { fontSize: 11 }, width: 40, tickFormatter: (v) => v + "%" }),
      /* @__PURE__ */ jsx11(Tooltip4, { formatter: (v) => v + "%" }),
      /* @__PURE__ */ jsx11(ReferenceLine2, { y: 100, stroke: "#1f9d55", strokeDasharray: "4 2" }),
      /* @__PURE__ */ jsx11(Line4, { type: "monotone", dataKey: "cover", name: "Coverage", stroke: "#0e7c86", dot: false, strokeWidth: 2, isAnimationActive: false })
    ] }) }),
    /* @__PURE__ */ jsx11("div", { className: "report-chart", "data-testid": "report-chart", "data-fixed-width": RW, children: /* @__PURE__ */ jsxs11(ComposedChart3, { width: RW, height: RH, data: hc, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
      /* @__PURE__ */ jsx11(CartesianGrid4, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
      /* @__PURE__ */ jsx11(XAxis4, { dataKey: "wk", tick: { fontSize: 11 }, interval: "preserveStartEnd", minTickGap: 18 }),
      /* @__PURE__ */ jsx11(YAxis4, { tick: { fontSize: 11 }, width: 40 }),
      /* @__PURE__ */ jsx11(Tooltip4, {}),
      /* @__PURE__ */ jsx11(Legend4, { wrapperStyle: { fontSize: 11 } }),
      /* @__PURE__ */ jsx11(Area2, { type: "monotone", dataKey: "trained", stackId: "hc", stroke: "#0e7c86", fill: "#0e7c86", fillOpacity: 0.75, isAnimationActive: false }),
      /* @__PURE__ */ jsx11(Area2, { type: "monotone", dataKey: "ramping", stackId: "hc", stroke: "#12a3b0", fill: "#57c3cc", fillOpacity: 0.7, isAnimationActive: false }),
      /* @__PURE__ */ jsx11(Area2, { type: "monotone", dataKey: "training", stackId: "hc", stroke: "#d98a0b", fill: "#f0c774", fillOpacity: 0.7, isAnimationActive: false }),
      /* @__PURE__ */ jsx11(Line4, { type: "monotone", dataKey: "required", name: "Required", stroke: "#0f1720", strokeWidth: 2, dot: false, isAnimationActive: false })
    ] }) })
  ] });
}
function ReportTab({ sim, strategySims, config, activeStrategy, activeViewId }) {
  const cur = config.engine.currency;
  const verdict = buildVerdict(strategySims, activeStrategy, activeViewId, config);
  const blocks = buildAudienceBlocks(sim, config);
  const risks = buildRiskRegister(sim, config);
  return /* @__PURE__ */ jsxs11("div", { className: "grid", style: { gap: 16 }, children: [
    /* @__PURE__ */ jsxs11("div", { className: "btnbar", children: [
      /* @__PURE__ */ jsx11("button", { type: "button", className: "btn primary", onClick: () => window.print(), children: "Print / Save as PDF" }),
      /* @__PURE__ */ jsx11("span", { className: "note", style: { padding: "6px 10px" }, children: "iPhone: Print \u2192 pinch out on the preview \u2192 Share \u2192 Save to Files." })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "report", "data-testid": "report", children: [
      /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h2", { style: { marginTop: 0 }, children: "Capacity plan \u2014 executive report" }),
        /* @__PURE__ */ jsxs11("p", { style: { color: "var(--muted)", marginTop: -6 }, children: [
          "Strategy ",
          activeStrategy,
          " (",
        ...
        /* @__PURE__ */ jsx11("p", { style: { fontSize: 14, lineHeight: 1.55 }, children: verdict.paragraph }),
        /* @__PURE__ */ jsxs11("div", { className: "stat-row", children: [
          /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
            /* @__PURE__ */ jsx11("div", { className: "l", children: "All-in cost" }),
            /* @__PURE__ */ jsx11("div", { className: "v", children: money(cur, blocks.finance.allIn) })
          ] }),
          /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
            /* @__PURE__ */ jsx11("div", { className: "l", children: "Run cost" }),
            /* @__PURE__ */ jsx11("div", { className: "v", children: money(cur, blocks.finance.runCost) })
          ] }),
          /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
            /* @__PURE__ */ jsx11("div", { className: "l", children: "Churn cost" }),
            /* @__PURE__ */ jsx11("div", { className: "v", children: money(cur, blocks.finance.churn) })
          ] }),
          /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
            /* @__PURE__ */ jsx11("div", { className: "l", children: "Customers lost" }),
            /* @__PURE__ */ jsx11("div", { className: "v", children: num(blocks.business.customersLost, 0) })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h3", { children: "Key findings" }),
        /* @__PURE__ */ jsxs11("ul", { style: { margin: 0, paddingLeft: 18 }, children: [
          sim.summary.findings.map((f, i) => /* @__PURE__ */ jsx11("li", { style: { marginBottom: 6, color: f.tone === "red" ? "var(--red)" : f.tone === "amber" ? "var(--amber)" : "var(--text)" }, children: f.text }, i)),
          sim.summary.findings.length === 0 && /* @__PURE__ */ jsx11("li", { children: "The plan holds across the horizon." })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h3", { children: "Risk register" }),
        /* @__PURE__ */ jsx11("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs11("table", { className: "data", children: [
          /* @__PURE__ */ jsx11("thead", { children: /* @__PURE__ */ jsxs11("tr", { children: [
            /* @__PURE__ */ jsx11("th", { children: "Risk" }),
            /* @__PURE__ */ jsx11("th", { children: "Week" }),
            /* @__PURE__ */ jsx11("th", { children: "Severity" }),
            /* @__PURE__ */ jsx11("th", { children: "Lever" })
          ] }) }),
          /* @__PURE__ */ jsxs11("tbody", { children: [
            risks.map((r, i) => /* @__PURE__ */ jsxs11("tr", { children: [
              /* @__PURE__ */ jsx11("td", { style: { textAlign: "left" }, children: r.risk }),
              /* @__PURE__ */ jsx11("td", { children: r.week ?? "\u2013" }),
              /* @__PURE__ */ jsx11("td", { children: r.severityMoney != null ? money(cur, r.severityMoney) : r.sla || "\u2013" }),
              /* @__PURE__ */ jsx11("td", { style: { textAlign: "left", whiteSpace: "normal" }, children: r.lever })
            ] }, i)),
            risks.length === 0 && /* @__PURE__ */ jsx11("tr", { children: /* @__PURE__ */ jsx11("td", { colSpan: 4, className: "empty", children: "No material risks." }) })
          ] })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h3", { children: "Strategy comparison" }),
        /* @__PURE__ */ jsx11("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs11("table", { className: "data", children: [
          /* @__PURE__ */ jsx11("thead", { children: /* @__PURE__ */ jsxs11("tr", { children: [
            /* @__PURE__ */ jsx11("th", { children: "Strategy" }),
            /* @__PURE__ */ jsx11("th", { children: "Red wks" }),
            /* @__PURE__ */ jsx11("th", { children: "End HC" }),
            /* @__PURE__ */ jsx11("th", { children: "Run cost" }),
            /* @__PURE__ */ jsx11("th", { children: "Churn" }),
            /* @__PURE__ */ jsx11("th", { children: "All-in" }),
            /* @__PURE__ */ jsx11("th", { children: "Feasible" })
          ] }) }),
          /* @__PURE__ */ jsx11("tbody", { children: STRATEGIES.filter((s) => strategySims[s.id]).map((s) => {
            const st = strategyStats(strategySims[s.id]);
            return /* @__PURE__ */ jsxs11("tr", { children: [
              /* @__PURE__ */ jsxs11("td", { style: { textAlign: "left" }, children: [
                s.id,
                " ",
                s.name
              ] }),
              /* @__PURE__ */ jsx11("td", { children: st.redWeeks }),
              /* @__PURE__ */ jsx11("td", { children: num(st.endHC, 0) }),
              /* @__PURE__ */ jsx11("td", { children: money(cur, st.runCost) }),
              /* @__PURE__ */ jsx11("td", { children: money(cur, st.churn) }),
              /* @__PURE__ */ jsx11("td", { children: money(cur, st.allIn) }),
              /* @__PURE__ */ jsx11("td", { children: st.feasible ? "yes" : "no" })
            ] }, s.id);
          }) })
        ] }) }),
        /* @__PURE__ */ jsx11("h4", { children: "Cumulative all-in cost by strategy" }),
        /* @__PURE__ */ jsx11(AllInChart, { strategySims, cur })
      ] }) }),
      config.queues.map((q) => /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h3", { children: q.name }),
        /* @__PURE__ */ jsx11(QueueKpis, { sim, queue: q, config }),
        /* @__PURE__ */ jsx11(QueueCharts, { sim, queue: q })
      ] }) }, q.id)),
      /* @__PURE__ */ jsx11("div", { className: "report-section card", children: /* @__PURE__ */ jsxs11("div", { className: "card-b", children: [
        /* @__PURE__ */ jsx11("h3", { children: "Assumptions" }),
        /* @__PURE__ */ jsx11(Assumptions, { config })
      ] }) })
    ] })
  ] });
}
function QueueKpis({ sim, queue, config }) {
  ...
  const worst = queue.type === "voice" ? { l: "Worst ASA", v: Math.round(Math.max(...rows.map((r) => r.asa))) + "s" } : { l: "Worst SL", v: pct(Math.min(...rows.map((r) => r.sl))) };
  return /* @__PURE__ */ jsxs11("div", { className: "stat-row", style: { marginBottom: 8 }, children: [
    /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
      /* @__PURE__ */ jsx11("div", { className: "l", children: "Red weeks" }),
      /* @__PURE__ */ jsx11("div", { className: "v", children: redWeeks })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
      /* @__PURE__ */ jsx11("div", { className: "l", children: worst.l }),
      /* @__PURE__ */ jsx11("div", { className: "v", children: worst.v })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
      /* @__PURE__ */ jsx11("div", { className: "l", children: "End paid / req" }),
    ...
    /* @__PURE__ */ jsxs11("div", { className: "stat", children: [
      /* @__PURE__ */ jsx11("div", { className: "l", children: "Total churn" }),
      /* @__PURE__ */ jsx11("div", { className: "v", children: money(cur, rows.reduce((a, r) => a + r.churnCost, 0)) })
    ] })
  ] });
}
function Assumptions({ config }) {
  ...
  const items = [
    ...
    ["\xA3 per lost customer", moneyFull(e.currency, config.cx.costPerLostCustomer)]
  ];
  return /* @__PURE__ */ jsx11("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsx11("table", { className: "data", children: /* @__PURE__ */ jsx11("tbody", { children: items.map(([k, v]) => /* @__PURE__ */ jsxs11("tr", { children: [
    /* @__PURE__ */ jsx11("td", { style: { textAlign: "left", fontWeight: 600 }, children: k }),
    /* @__PURE__ */ jsx11("td", { style: { textAlign: "left" }, children: v })
  ] }, k)) }) }) });
}

// ui/components/RunsTab.jsx
import { useState as useState8 } from "react";
import { LineChart as LineChart4, Line as Line5, XAxis as XAxis5, YAxis as YAxis5, CartesianGrid as CartesianGrid5, Tooltip as Tooltip5, Legend as Legend5 } from "recharts";
...
function RunsTab({ runs, storageMode, storageNotice, compareSel, setCompareSel, onSave, onLoadSettings, onDelete, onRefresh, config }) {
  ...
  return /* @__PURE__ */ jsxs12("div", { className: "grid", style: { gap: 16 }, children: [
    /* @__PURE__ */ jsxs12(
      Card,
      {
        ...
        right: /* @__PURE__ */ jsx12("button", { type: "button", className: "btn sm", onClick: onRefresh, children: "Refresh" }),
        children: [
          storageNotice && /* @__PURE__ */ jsx12("p", { className: "note", style: { marginBottom: 12, color: "var(--amber)" }, children: storageNotice }),
          /* @__PURE__ */ jsxs12("div", { className: "rowflex", children: [
            /* @__PURE__ */ jsx12("input", { type: "text", className: "inp", style: { maxWidth: 260 }, placeholder: "run name", value: name, onChange: (e) => setName(e.target.value), "data-testid": "run-name" }),
            /* @__PURE__ */ jsx12("button", { type: "button", className: "btn primary", "data-testid": "save-run", disabled: !name.trim(), onClick: () => {
              onSave(name.trim());
              setName("");
            }, children: "Save current plan" })
          ] }),
          /* @__PURE__ */ jsx12("div", { className: "tbl-wrap", style: { marginTop: 14 }, children: /* @__PURE__ */ jsxs12("table", { className: "data", "data-testid": "runs-table", children: [
            /* @__PURE__ */ jsx12("thead", { children: /* @__PURE__ */ jsxs12("tr", { children: [
              /* @__PURE__ */ jsx12("th", { children: "Compare" }),
              /* @__PURE__ */ jsx12("th", { children: "Name" }),
              /* @__PURE__ */ jsx12("th", { children: "Saved" }),
              /* @__PURE__ */ jsx12("th", { children: "Strategy" }),
              /* @__PURE__ */ jsx12("th", { children: "All-in" }),
              /* @__PURE__ */ jsx12("th", { children: "Actions" })
            ] }) }),
            /* @__PURE__ */ jsxs12("tbody", { children: [
              runs.map((r) => /* @__PURE__ */ jsxs12("tr", { children: [
                /* @__PURE__ */ jsx12("td", { children: /* @__PURE__ */ jsxs12("label", { className: "switch", style: { justifyContent: "center" }, children: [
                  /* @__PURE__ */ jsx12("input", { type: "checkbox", checked: compareSel.includes(r.slug), onChange: () => toggle(r.slug), "data-testid": "tick-" + r.slug }),
                  /* @__PURE__ */ jsx12("span", { className: "track", "aria-hidden": "true" })
                ] }) }),
                /* @__PURE__ */ jsx12("td", { style: { textAlign: "left", fontWeight: 600 }, children: r.name }),
                /* @__PURE__ */ jsx12("td", { children: dt(r.savedAt) }),
                /* @__PURE__ */ jsx12("td", { children: r.strategy }),
                /* @__PURE__ */ jsx12("td", { children: money(cur, r.allIn) }),
                /* @__PURE__ */ jsx12("td", { children: /* @__PURE__ */ jsxs12("span", { className: "btnbar", children: [
                  /* @__PURE__ */ jsx12("button", { type: "button", className: "btn sm", onClick: () => onLoadSettings(r), children: "Load settings" }),
                  /* @__PURE__ */ jsx12("button", { type: "button", className: "btn sm", onClick: () => downloadText(`${r.slug}.json`, JSON.stringify({ kind: "capacity-run", savedAt: r.savedAt, config: r.config, run: r.run }, null, 2), "application/json"), children: "Download" }),
                  /* @__PURE__ */ jsx12("button", { type: "button", className: "btn sm danger", onClick: () => onDelete(r), children: "Delete" })
                ] }) })
              ] }, r.slug)),
              runs.length === 0 && /* @__PURE__ */ jsx12("tr", { children: /* @__PURE__ */ jsx12("td", { colSpan: 6, className: "empty", children: "No saved runs yet \u2014 save the current plan above." }) })
            ] })
          ] }) })
        ]
      }
    ),
    selected.length > 0 && /* @__PURE__ */ jsxs12(Card, { title: "Compare", sub: `${selected.length} run(s) ticked`, hint: "Ticked runs compared side by side. Deltas are versus the first ticked run.", children: [
      /* @__PURE__ */ jsx12(TotalsDelta, { runs: selected, cur }),
      /* @__PURE__ */ jsx12("h4", { style: { margin: "18px 0 6px", fontSize: 13 }, children: "Cumulative all-in cost" }),
      /* @__PURE__ */ jsx12(AllInOverlay, { runs: selected, cur }),
      /* @__PURE__ */ jsx12("h4", { style: { margin: "18px 0 6px", fontSize: 13 }, children: "Per-queue comparison (matched by name)" }),
      /* @__PURE__ */ jsx12(PerQueue, { runs: selected, cur })
    ] })
  ] });
}
function TotalsDelta({ runs, cur }) {
  ...
  return /* @__PURE__ */ jsx12("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs12("table", { className: "data", "data-testid": "totals-delta", children: [
    /* @__PURE__ */ jsx12("thead", { children: /* @__PURE__ */ jsxs12("tr", { children: [
      /* @__PURE__ */ jsx12("th", { children: "Run" }),
      metrics.map((m) => /* @__PURE__ */ jsx12("th", { children: m.label }, m.key))
    ] }) }),
    /* @__PURE__ */ jsx12("tbody", { children: rows.map((r) => /* @__PURE__ */ jsxs12("tr", { children: [
...
function AllInOverlay({ runs, cur }) {
  ...
  return /* @__PURE__ */ jsx12(Chart, { title: "", height: 240, children: (w, h) => /* @__PURE__ */ jsxs12(LineChart4, { width: w, height: h, data, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
    /* @__PURE__ */ jsx12(CartesianGrid5, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
    /* @__PURE__ */ jsx12(XAxis5, { dataKey: "wk", tick: { fontSize: 11 }, interval: "preserveStartEnd", minTickGap: 18 }),
    /* @__PURE__ */ jsx12(YAxis5, { tick: { fontSize: 11 }, width: 52, tickFormatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx12(Tooltip5, { formatter: (v) => money(cur, v) }),
    /* @__PURE__ */ jsx12(Legend5, { wrapperStyle: { fontSize: 11 } }),
    runs.map((r, i) => /* @__PURE__ */ jsx12(Line5, { type: "monotone", dataKey: r.slug, name: r.name, stroke: SERIES3[i % SERIES3.length], dot: false, strokeWidth: 2, isAnimationActive: false }, r.slug))
  ] }) });
}
function PerQueue({ runs, cur }) {
  const blocks = perQueueBlocks(runs);
  return /* @__PURE__ */ jsx12("div", { className: "grid", style: { gap: 12 }, "data-testid": "per-queue-compare", children: blocks.map((b) => /* @__PURE__ */ jsxs12("div", { className: "erow", children: [
    /* @__PURE__ */ jsx12("div", { className: "erow-h", children: /* @__PURE__ */ jsx12("strong", { children: b.name }) }),
    /* @__PURE__ */ jsxs12("div", { className: "erow-b", children: [
      /* @__PURE__ */ jsx12("div", { className: "tbl-wrap", children: /* @__PURE__ */ jsxs12("table", { className: "data", children: [
        /* @__PURE__ */ jsx12("thead", { children: /* @__PURE__ */ jsxs12("tr", { children: [
          /* @__PURE__ */ jsx12("th", { children: "Run" }),
          /* @__PURE__ */ jsx12("th", { children: "Red wks" }),
          /* @__PURE__ */ jsx12("th", { children: "Avg cover" }),
          /* @__PURE__ */ jsx12("th", { children: "Worst" }),
          /* @__PURE__ */ jsx12("th", { children: "Cost" }),
          /* @__PURE__ */ jsx12("th", { children: "Churn" })
        ] }) }),
        /* @__PURE__ */ jsx12("tbody", { children: b.cells.map((c, i) => /* @__PURE__ */ jsxs12("tr", { children: [
          /* @__PURE__ */ jsx12("td", { style: { textAlign: "left" }, children: c.run.name }),
          c.present ? /* @__PURE__ */ jsxs12(Fragment5, { children: [
            /* @__PURE__ */ jsx12("td", { className: c.redWeeks ? "st-red" : "st-green", children: c.redWeeks }),
            /* @__PURE__ */ jsx12("td", { children: pct(c.avgCover) }),
            /* @__PURE__ */ jsx12("td", { children: c.worst.fmt === "s" ? secs(c.worst.value) : pct(c.worst.value) }),
            /* @__PURE__ */ jsx12("td", { children: money(cur, c.cost) }),
            /* @__PURE__ */ jsx12("td", { children: money(cur, c.churn) })
          ] }) : /* @__PURE__ */ jsx12("td", { colSpan: 5, className: "empty", children: "not in this run" })
        ] }, i)) })
      ] }) }),
      /* @__PURE__ */ jsx12(Chart, { title: "", height: 180, children: (w, h) => /* @__PURE__ */ jsxs12(LineChart4, { width: w, height: h, margin: { top: 8, right: 16, left: 8, bottom: 4 }, children: [
        /* @__PURE__ */ jsx12(CartesianGrid5, { strokeDasharray: "3 3", stroke: "#eef2f5" }),
        /* @__PURE__ */ jsx12(XAxis5, { dataKey: "wk", type: "number", domain: [1, "dataMax"], tick: { fontSize: 11 }, allowDuplicatedCategory: false }),
        /* @__PURE__ */ jsx12(YAxis5, { tick: { fontSize: 11 }, width: 40, tickFormatter: (v) => v + "%" }),
        /* @__PURE__ */ jsx12(Tooltip5, { formatter: (v) => v + "%" }),
        /* @__PURE__ */ jsx12(Legend5, { wrapperStyle: { fontSize: 11 } }),
        b.cells.filter((c) => c.present).map((c, i) => /* @__PURE__ */ jsx12(Line5, { data: c.coverSeries, dataKey: "cover", name: c.run.name, stroke: SERIES3[i % SERIES3.length], dot: false, strokeWidth: 2, isAnimationActive: false }, i))
      ] }) })
    ] })
  ] }, b.name)) });
}

// ui/components/NotesTab.jsx
import { jsx as jsx13, jsxs as jsxs13 } from "react/jsx-runtime";
function NotesTab() {
  return /* @__PURE__ */ jsx13("div", { className: "grid", style: { gap: 16 }, children: /* @__PURE__ */ jsxs13(Card, { title: "How the model works", sub: "plain-language notes on the engine", children: [
    /* @__PURE__ */ jsx13("p", { className: "note", style: { marginBottom: 16 }, children: "This tool simulates a call centre week by week across the horizon. Below is what the engine actually does, in plain terms \u2014 the same three ideas that make its numbers trustworthy rather than optimistic." }),
    /* @__PURE__ */ jsx13("h4", { style: { margin: "0 0 6px" }, children: "E1 \u2014 Callers abandon (Erlang A, not Erlang C)" }),
    /* @__PURE__ */ jsxs13("p", { style: { marginTop: 0 }, children: [
      "The classic Erlang C formula assumes every caller waits forever. That makes predicted waits explode as a queue gets busy, which never happens in reality \u2014 real callers hang up. We use ",
      /* @__PURE__ */ jsx13("strong", { children: "Erlang A" }),
      ", which models patience: some callers abandon, and because an abandoned call is never handled, it lightens the load on the agents who remain. The engine solves this self-consistently (the abandonment rate and the served load depend on each other) so the predicted speed-of-answer stays realistic and bounded by caller patience. In quiet conditions it matches the textbook Erlang C answer exactly; in heavy overload it falls back to simple flow conservation (roughly one-minus-agents-over-demand abandon)."
    ] }),
    /* @__PURE__ */ jsx13("h4", { style: { margin: "16px 0 6px" }, children: "E2 \u2014 Staff follow the requirement curve, not the demand curve" }),
    /* @__PURE__ */ jsxs13("p", { style: { marginTop: 0 }, children: [
      "Queues enjoy economies of scale: a busy interval needs proportionally ",
      /* @__PURE__ */ jsx13("em", { children: "fewer" }),
      " agents per call than a quiet one. So spreading available hours in proportion to call volume would starve the quiet intervals and invent abandonment that wouldn't really occur. Instead the engine computes the agents ",
      /* @__PURE__ */ jsx13("strong", { children: "required" }),
      " in each interval and lays the available hours along that shape. Coverage then becomes one honest number: 100% means SLA is met in every interval; 90% means you are uniformly about 10% short. This is a best-case rostering assumption \u2014 real rosters are lumpier \u2014 and is stated as such."
    ] }),
    /* @__PURE__ */ jsx13("h4", { style: { margin: "16px 0 6px" }, children: "E3 \u2014 Digital is a fluid backlog, not a phone queue" }),
    /* @__PURE__ */ jsx13("p", { style: { marginTop: 0 }, children: "Chat and messaging don't block like a phone line \u2014 contacts wait in a backlog and agents handle several at once. The engine models the backlog as a fluid that fills and drains: within each interval, arrivals come in steadily and the wait a contact sees rises or falls linearly with the backlog, which is how the in-SLA share is derived. Backlog carries across intervals, days and weeks. There is no Erlang scale effect here \u2014 required capacity is simply demand divided by concurrency and the occupancy ceiling. When a digital backlog runs over its limit, a share of it deflects into next-day voice volume." }),
    /* @__PURE__ */ jsx13("hr", { className: "sep", style: { margin: "18px 0" } }),
    /* @__PURE__ */ jsx13("h4", { style: { margin: "0 0 6px" }, children: "Other mechanics worth knowing" }),
    /* @__PURE__ */ jsxs13("ul", { style: { margin: 0, paddingLeft: 18, lineHeight: 1.6 }, children: [
      /* @__PURE__ */ jsx13("li", { children: "New hires take req-to-start weeks to begin, then train (full salary, zero output), then ramp up their learning curve before counting as fully productive." }),
      /* @__PURE__ */ jsx13("li", { children: "Attrition erodes trained and ramping staff (never trainees); a burnout index builds while occupancy sits above threshold, lifting attrition and absence." }),
      /* @__PURE__ */ jsx13("li", { children: "Abandoned callers redial (solved as a capped fixed point) and over-limit digital backlog deflects to voice \u2014 both shown as distinct volume segments." }),
      /* @__PURE__ */ jsx13("li", { children: "Poor experience converts to churn (abandonment, long waits, digital breaches) at editable rates, priced per lost customer, and weighed against idle pay." }),
      /* @__PURE__ */ jsx13("li", { children: "All four hiring strategies run every change; the active one drives the dashboard. A global weekly hiring cap is rationed to the queue with the greatest churn cost averted per hire when it binds." })
    ] })
  ] }) });
}
...
function FilesCard({ sim, strategySims, config, activeStrategy, activeViewId, onImportConfig }) {
  ...
  return /* @__PURE__ */ jsxs14(Card, { title: "Files \u2014 export & import", hint: "One workbook round-trips Parameters and Volumes; config and saved-run JSON share whole plans; CSVs are plain-text fallbacks.", children: [
    /* @__PURE__ */ jsxs14("div", { className: "btnbar", children: [
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn primary", "data-testid": "export-workbook", onClick: onWorkbook, children: "Export Excel workbook" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", "data-testid": "export-config", onClick: () => downloadText("capacity-config.json", configJSON(config), "application/json"), children: "Export config JSON" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", "data-testid": "export-run", onClick: () => downloadText("capacity-run.json", runJSON(sim, config), "application/json"), children: "Export saved run" })
    ] }),
    /* @__PURE__ */ jsxs14("div", { className: "btnbar", style: { marginTop: 8 }, children: [
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", "data-testid": "export-params-csv", onClick: () => downloadText("parameters.csv", parametersCSV(config), "text/csv"), children: "Parameters CSV" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", "data-testid": "export-volumes-csv", onClick: () => downloadText("volumes.csv", volumesCSV(config), "text/csv"), children: "Volumes CSV" })
    ] }),
    /* @__PURE__ */ jsx14("hr", { className: "sep", style: { margin: "14px 0" } }),
    /* @__PURE__ */ jsxs14("div", { className: "btnbar", children: [
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", onClick: () => wbInput.current && wbInput.current.click(), children: "Import Excel (Parameters + Volumes)" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", onClick: () => cfgInput.current && cfgInput.current.click(), children: "Import config JSON" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", onClick: () => runInput.current && runInput.current.click(), children: "Import saved run" }),
      /* @__PURE__ */ jsx14("button", { type: "button", className: "btn", onClick: () => csvInput.current && csvInput.current.click(), children: "Import parameters CSV" }),
      /* @__PURE__ */ jsx14("input", { ref: wbInput, type: "file", accept: ".xlsx", "data-testid": "import-workbook", style: { display: "none" }, onChange: (e) => e.target.files[0] && importWorkbook(e.target.files[0]) }),
      /* @__PURE__ */ jsx14("input", { ref: cfgInput, type: "file", accept: ".json", "data-testid": "import-config", style: { display: "none" }, onChange: (e) => e.target.files[0] && importConfig(e.target.files[0]) }),
      /* @__PURE__ */ jsx14("input", { ref: runInput, type: "file", accept: ".json", "data-testid": "import-run", style: { display: "none" }, onChange: (e) => e.target.files[0] && importRun(e.target.files[0]) }),
      /* @__PURE__ */ jsx14("input", { ref: csvInput, type: "file", accept: ".csv", "data-testid": "import-params-csv", style: { display: "none" }, onChange: (e) => e.target.files[0] && importParamsCSV(e.target.files[0]) })
    ] }),
    msg && /* @__PURE__ */ jsx14("p", { className: "note", style: { marginTop: 12, color: msg.tone === "err" ? "var(--red)" : void 0 }, children: msg.text }),
    /* @__PURE__ */ jsx14("p", { className: "note", style: { marginTop: 10 }, children: "Importing a workbook reads only the Parameters and Volumes sheets (output sheets are ignored) and patches your config by path. Config and saved-run JSON replace the whole plan." })
  ] });
}
...
function PresetBar({ presets, onApply, onSaveAs, applyLabel = "Preset" }) {
  const [pick, setPick] = useState10("");
  const [name, setName] = useState10("");
  return /* @__PURE__ */ jsxs15("div", { className: "rowflex", children: [
    /* @__PURE__ */ jsx15("div", { style: { minWidth: 200 }, children: /* @__PURE__ */ jsx15(
      SelectField,
      {
        label: applyLabel,
        value: pick,
    ...
    /* @__PURE__ */ jsxs15("label", { className: "field", style: { minWidth: 160 }, children: [
      /* @__PURE__ */ jsx15("span", { className: "lab", children: "Save current as" }),
      /* @__PURE__ */ jsx15("input", { type: "text", value: name, placeholder: "my preset", onChange: (e) => setName(e.target.value) })
    ] }),
    /* @__PURE__ */ jsx15(
      "button",
      {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "grid", style: { gap: 14 }, children: [
    /* @__PURE__ */ jsxs16("div", { className: "btnbar", children: [
      ...
      /* @__PURE__ */ jsxs16("span", { className: "note", style: { padding: "6px 10px" }, children: [
        ...
        " queue(s). Changes recalculate automatically."
      ] })
    ] }),
    /* @__PURE__ */ jsx16("div", { className: "rows", children: config.queues.map((q, qi) => /* @__PURE__ */ jsxs16("details", { className: "erow", open: qi === 0, children: [
      /* @__PURE__ */ jsxs16("summary", { children: [
        /* @__PURE__ */ jsx16("span", { className: "chev", children: "\u25B6" }),
        /* @__PURE__ */ jsx16("strong", { children: q.name }),
        /* @__PURE__ */ jsx16("span", { className: "pill", children: q.type }),
      ...
      /* @__PURE__ */ jsxs16("div", { className: "erow-b", children: [
        /* @__PURE__ */ jsxs16("div", { className: "fieldrow", children: [
          ...
          /* @__PURE__ */ jsx16(NumField, { label: "Base daily volume", value: q.dailyVolume, onChange: (v) => ops.patchQueue(q.id, ["dailyVolume"], v), hint: "Contacts per day before seasonality, scenarios and endogenous load." }),
          /* @__PURE__ */ jsx16(NumField, { label: "AHT / handle time", unit: "s", value: q.aht, onChange: (v) => ops.patchQueue(q.id, ["aht"], v) })
        ] }),
        q.type === "voice" ? /* @__PURE__ */ jsxs16("div", { className: "fieldrow", children: [
          ...
          /* @__PURE__ */ jsx16(NumField, { label: "Patience", unit: "s", value: q.patience, onChange: (v) => ops.patchQueue(q.id, ["patience"], v), hint: "Mean caller patience \u2014 drives the Erlang A abandonment solve." })
        ] }) : /* @__PURE__ */ jsxs16("div", { className: "fieldrow", children: [
          /* @__PURE__ */ jsx16(NumField, { label: "Concurrency", value: q.concurrency, onChange: (v) => ops.patchQueue(q.id, ["concurrency"], v), hint: "Simultaneous conversations an agent handles." }),
          ...
          /* @__PURE__ */ jsx16(NumField, { label: "Backlog limit", value: q.backlogLimit, onChange: (v) => ops.patchQueue(q.id, ["backlogLimit"], v), hint: "Backlog above this deflects a share to voice next day." }),
          /* @__PURE__ */ jsx16(
            SelectField,
            {
              label: "Deflects to",
        ...
        /* @__PURE__ */ jsxs16("div", { className: "fieldrow", children: [
          /* @__PURE__ */ jsx16(NumField, { label: "Starting FTE", value: q.fte, onChange: (v) => ops.patchQueue(q.id, ["fte"], v) }),
          /* @__PURE__ */ jsx16(NumField, { label: "Shrinkage", unit: "%", value: +(q.shrinkage * 100).toFixed(1), onChange: (v) => ops.patchQueue(q.id, ["shrinkage"], v / 100), hint: "Non-productive time: breaks, training, admin, absence." }),
          /* @__PURE__ */ jsx16(NumField, { label: "Fully loaded cost", unit: "/yr", value: q.agentCost, onChange: (v) => ops.patchQueue(q.id, ["agentCost"], v) })
        ] }),
        /* @__PURE__ */ jsxs16("div", { children: [
          /* @__PURE__ */ jsxs16("div", { className: "lab", style: { marginBottom: 6, display: "flex", gap: 6, alignItems: "center" }, children: [
            "Cross-skill donors ",
            /* @__PURE__ */ jsx16(Hint, { text: "Queues this one can borrow spare hours from, in priority order (list order). Flexing happens at day level with a flex proficiency." })
          ] }),
          /* @__PURE__ */ jsxs16("div", { className: "rowflex", children: [
            config.queues.filter((x) => x.id !== q.id).map((x) => /* @__PURE__ */ jsxs16("label", { className: "switch", children: [
              /* @__PURE__ */ jsx16(
                "input",
                {
                  type: "checkbox",
              ...
              /* @__PURE__ */ jsx16("span", { children: x.name })
            ] }, x.id)),
            config.queues.length < 2 && /* @__PURE__ */ jsx16("span", { className: "note", style: { padding: "6px 10px" }, children: "Add another queue to enable cross-skilling." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs16(Card, { title: "Intraday arrival pattern", hint: "Relative arrival share per 30-min interval. Apply a preset, hand-edit the sliders, then save your curve back to the library.", children: [
          /* @__PURE__ */ jsx16(
            PresetBar,
            {
...
// ui/editors/WorkforceEditor.jsx
import { jsx as jsx17, jsxs as jsxs17 } from "react/jsx-runtime";
function WorkforceEditor({ config, ops }) {
  return /* @__PURE__ */ jsxs17("div", { className: "grid", style: { gap: 14 }, children: [
    /* @__PURE__ */ jsxs17("p", { className: "note", children: [
      "Manual hires below feed strategy ",
      /* @__PURE__ */ jsx17("strong", { children: "S4 (Manual plan)" }),
      ". Select S4 as the active strategy in Money & engine to drive the dashboard from them."
    ] }),
    /* @__PURE__ */ jsx17("div", { className: "rows", children: config.queues.map((q, qi) => {
      const wf = q.wf, burn = q.burn;
      return /* @__PURE__ */ jsxs17("details", { className: "erow", open: qi === 0, children: [
        /* @__PURE__ */ jsxs17("summary", { children: [
          /* @__PURE__ */ jsx17("span", { className: "chev", children: "\u25B6" }),
          /* @__PURE__ */ jsx17("strong", { children: q.name }),
          /* @__PURE__ */ jsx17("span", { className: "pill", children: q.type }),
        ...
        /* @__PURE__ */ jsxs17("div", { className: "erow-b", children: [
          /* @__PURE__ */ jsxs17("div", { className: "fieldrow", children: [
            ...
            /* @__PURE__ */ jsx17(NumField, { label: "Attrition growth", unit: "\xD7/mo", value: wf.attritionGrowth, step: "0.01", onChange: (v) => ops.patchQueue(q.id, ["wf", "attritionGrowth"], v), hint: "Compounding drift in the monthly attrition rate over the horizon." }),
            /* @__PURE__ */ jsx17(NumField, { label: "Req-to-start", unit: "wk", value: wf.reqToStart, onChange: (v) => ops.patchQueue(q.id, ["wf", "reqToStart"], v), hint: "Weeks from raising a requisition to a new hire starting." }),
            /* @__PURE__ */ jsx17(NumField, { label: "Training", unit: "wk", value: wf.trainingWeeks, onChange: (v) => ops.patchQueue(q.id, ["wf", "trainingWeeks"], v), hint: "Trainees cost full salary and deliver zero productivity." })
          ] }),
          /* @__PURE__ */ jsxs17("div", { children: [
            /* @__PURE__ */ jsxs17("div", { className: "lab", style: { marginBottom: 6, display: "flex", gap: 6, alignItems: "center" }, children: [
              "Learning curve ",
              /* @__PURE__ */ jsx17(Hint, { text: "Productive share of a fully-ramped agent, one entry per week after training. Ramping agents deliver their curve share." })
            ] }),
            /* @__PURE__ */ jsxs17("div", { className: "rowflex", children: [
              wf.learningCurve.map((c, ci) => /* @__PURE__ */ jsx17("div", { style: { width: 92 }, children: /* @__PURE__ */ jsx17(NumField, { label: "wk " + (ci + 1), unit: "%", value: +(c * 100).toFixed(0), onChange: (v) => {
                const next = wf.learningCurve.slice();
                next[ci] = v / 100;
                ops.patchQueue(q.id, ["wf", "learningCurve"], next);
              } }) }, ci)),
              /* @__PURE__ */ jsxs17("div", { className: "btnbar", children: [
                /* @__PURE__ */ jsx17("button", { type: "button", className: "btn sm", onClick: () => ops.patchQueue(q.id, ["wf", "learningCurve"], [...wf.learningCurve, 1]), children: "+ stage" }),
                /* @__PURE__ */ jsx17("button", { type: "button", className: "btn sm", disabled: wf.learningCurve.length <= 1, onClick: () => ops.patchQueue(q.id, ["wf", "learningCurve"], wf.learningCurve.slice(0, -1)), children: "\u2212 stage" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx17(Card, { title: "Burnout", hint: "Accumulates while occupancy exceeds the threshold; multiplies attrition and adds absence shrinkage.", children: /* @__PURE__ */ jsxs17("div", { className: "fieldrow", children: [
            /* @__PURE__ */ jsx17(NumField, { label: "Occ. threshold", unit: "%", value: +(burn.occThreshold * 100).toFixed(0), onChange: (v) => ops.patchQueue(q.id, ["burn", "occThreshold"], v / 100) }),
            /* @__PURE__ */ jsx17(NumField, { label: "Sensitivity", value: burn.sensitivity, step: "0.1", onChange: (v) => ops.patchQueue(q.id, ["burn", "sensitivity"], v) }),
            /* @__PURE__ */ jsx17(NumField, { label: "Recovery", unit: "/wk", value: burn.recovery, onChange: (v) => ops.patchQueue(q.id, ["burn", "recovery"], v) }),
            /* @__PURE__ */ jsx17(NumField, { label: "Max attrition \xD7", value: burn.maxAttritionMult, step: "0.1", onChange: (v) => ops.patchQueue(q.id, ["burn", "maxAttritionMult"], v) }),
            /* @__PURE__ */ jsx17(NumField, { label: "Absence uplift", unit: "%", value: +(burn.absenceUplift * 100).toFixed(0), onChange: (v) => ops.patchQueue(q.id, ["burn", "absenceUplift"], v / 100) })
          ] }) }),
          /* @__PURE__ */ jsx17(
            Card,
            {
              ...
              right: /* @__PURE__ */ jsx17("button", { type: "button", className: "btn sm primary", onClick: () => ops.addHire(q.id), children: "+ Add hire" }),
              children: (wf.hires || []).length === 0 ? /* @__PURE__ */ jsx17("div", { className: "empty", children: "No manual hires yet." }) : /* @__PURE__ */ jsx17("div", { className: "rows", children: wf.hires.map((h, hi) => /* @__PURE__ */ jsxs17("div", { className: "rowflex", children: [
                /* @__PURE__ */ jsx17("div", { style: { width: 130 }, children: /* @__PURE__ */ jsx17(NumField, { label: "Week", value: h.week + 1, min: 1, onChange: (v) => ops.patchHire(q.id, hi, "week", Math.max(0, v - 1)) }) }),
                /* @__PURE__ */ jsx17("div", { style: { width: 130 }, children: /* @__PURE__ */ jsx17(NumField, { label: "Heads", value: h.heads, onChange: (v) => ops.patchHire(q.id, hi, "heads", v) }) }),
...
// ui/editors/MoneyEditor.jsx
import { jsx as jsx18, jsxs as jsxs18 } from "react/jsx-runtime";
function MoneyEditor({ config, ops }) {
  ...
  return /* @__PURE__ */ jsxs18("div", { className: "grid cols-2", style: { alignItems: "start" }, children: [
    /* @__PURE__ */ jsxs18(Card, { title: "Engine", children: [
      /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
        /* @__PURE__ */ jsx18(NumField, { label: "Horizon", unit: "wk", value: eng.horizonWeeks, min: 1, onChange: (v) => P(["engine", "horizonWeeks"], Math.max(1, Math.round(v))) }),
        /* @__PURE__ */ jsx18(NumField, { label: "Occupancy ceiling", unit: "%", value: +(eng.occupancyCeiling * 100).toFixed(0), onChange: (v) => P(["engine", "occupancyCeiling"], v / 100), hint: "Maximum sustainable utilisation before requirement is inflated." }),
      ...
      /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
        /* @__PURE__ */ jsx18(NumField, { label: "Days / week", value: eng.daysPerWeek, onChange: (v) => P(["engine", "daysPerWeek"], v) }),
        /* @__PURE__ */ jsx18(NumField, { label: "FTE hrs / day", value: eng.hoursPerFteDay, onChange: (v) => P(["engine", "hoursPerFteDay"], v) }),
        /* @__PURE__ */ jsx18(NumField, { label: "FTE days", value: eng.daysWorkedPerFte, onChange: (v) => P(["engine", "daysWorkedPerFte"], v) }),
        /* @__PURE__ */ jsx18(NumField, { label: "Cross-skill prof.", unit: "%", value: +(eng.crossSkillProficiency * 100).toFixed(0), onChange: (v) => P(["engine", "crossSkillProficiency"], v / 100) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs18(Card, { title: "Hiring & strategy", children: [
      /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
        /* @__PURE__ */ jsx18(NumField, { label: "Global cap", unit: "/wk", value: hir.cap, onChange: (v) => P(["hiring", "cap"], v), hint: "Max total requisitions per week across all queues \u2014 a shared recruitment/training constraint." }),
        /* @__PURE__ */ jsx18(NumField, { label: "Buffer", unit: "%", value: +(hir.buffer * 100).toFixed(0), onChange: (v) => P(["hiring", "buffer"], v / 100), hint: "S2 targets requirement \xD7 (1 + buffer)." })
      ] }),
      /* @__PURE__ */ jsxs18("p", { className: "note", style: { marginTop: 10 }, children: [
        "All four strategies run side by side on the ",
        /* @__PURE__ */ jsx18("strong", { children: "Strategies" }),
        " tab; pick the active one from the strategy selector in the top bar."
      ] })
    ] }),
    /* @__PURE__ */ jsxs18(Card, { title: "Costs", children: [
      ...
      /* @__PURE__ */ jsx18("p", { className: "note", style: { marginTop: 10 }, children: "Per-agent fully-loaded cost is set per queue in the Queues editor." })
    ] }),
    /* @__PURE__ */ jsxs18(Card, { title: "CX economics", hint: "How poor experience converts to churn and lost revenue.", children: [
      /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
        /* @__PURE__ */ jsx18(NumField, { label: "Customer base", value: cx.customerBase, onChange: (v) => P(["cx", "customerBase"], v) }),
        /* @__PURE__ */ jsx18(NumField, { label: "\xA3 per lost customer", value: cx.costPerLostCustomer, onChange: (v) => P(["cx", "costPerLostCustomer"], v) }),
        /* @__PURE__ */ jsx18(NumField, { label: "Repeat uplift", unit: "\xD7", value: cx.repeatUplift, step: "0.1", onChange: (v) => P(["cx", "repeatUplift"], v) })
      ] }),
      /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
        /* @__PURE__ */ jsx18(NumField, { label: "Churn \u2014 abandon", unit: "%", value: +(cx.churnAbandon * 100).toFixed(1), onChange: (v) => P(["cx", "churnAbandon"], v / 100) }),
        /* @__PURE__ */ jsx18(NumField, { label: "Churn \u2014 long wait", unit: "%", value: +(cx.churnWait * 100).toFixed(1), onChange: (v) => P(["cx", "churnWait"], v / 100) }),
        /* @__PURE__ */ jsx18(NumField, { label: "Churn \u2014 digital breach", unit: "%", value: +(cx.churnDigital * 100).toFixed(1), onChange: (v) => P(["cx", "churnDigital"], v / 100) })
      ] })
    ] }),
    /* @__PURE__ */ jsx18(Card, { title: "Endogenous loops", children: /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
      /* @__PURE__ */ jsx18(NumField, { label: "Redial rate", unit: "%", value: +(loops.redial * 100).toFixed(0), onChange: (v) => P(["loops", "redial"], v / 100), hint: "Share of abandoned callers who call back \u2014 solved as a fixed point, capped at 4\xD7 base." }),
      /* @__PURE__ */ jsx18(NumField, { label: "Deflection rate", unit: "%", value: +(loops.deflection * 100).toFixed(0), onChange: (v) => P(["loops", "deflection"], v / 100), hint: "Share of over-limit digital backlog that becomes next-day voice volume." })
    ] }) }),
    /* @__PURE__ */ jsx18(
      Card,
      {
        ...
        right: /* @__PURE__ */ jsx18("button", { type: "button", className: "btn sm primary", onClick: ops.addServiceTeam, children: "+ Add team" }),
        children: config.serviceTeams.length === 0 ? /* @__PURE__ */ jsx18("div", { className: "empty", children: "No service teams." }) : /* @__PURE__ */ jsx18("div", { className: "rows", children: config.serviceTeams.map((t, ti) => /* @__PURE__ */ jsxs18("div", { className: "erow", children: [
          /* @__PURE__ */ jsxs18("div", { className: "erow-h", children: [
            /* @__PURE__ */ jsx18("strong", { children: t.name }),
            /* @__PURE__ */ jsx18("span", { className: "spacer" }),
            /* @__PURE__ */ jsx18("button", { type: "button", className: "btn sm danger", onClick: () => ops.deleteServiceTeam(t.id), children: "Delete" })
          ] }),
          /* @__PURE__ */ jsxs18("div", { className: "erow-b", children: [
            /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
              /* @__PURE__ */ jsx18(TextField, { label: "Name", value: t.name, onChange: (v) => ops.patchServiceTeam(ti, ["name"], v) }),
              /* @__PURE__ */ jsx18(NumField, { label: "Size", value: t.size, onChange: (v) => ops.patchServiceTeam(ti, ["size"], v) }),
              /* @__PURE__ */ jsx18(NumField, { label: "Premium", unit: "%", value: +(t.premiumPct * 100).toFixed(0), onChange: (v) => ops.patchServiceTeam(ti, ["premiumPct"], v / 100) }),
              /* @__PURE__ */ jsx18(NumField, { label: "Proficiency", unit: "%", value: +(t.proficiency * 100).toFixed(0), onChange: (v) => ops.patchServiceTeam(ti, ["proficiency"], v / 100) })
            ] }),
            /* @__PURE__ */ jsxs18("div", { className: "fieldrow", children: [
              /* @__PURE__ */ jsx18(NumField, { label: "Trigger occ.", unit: "%", value: +(t.triggerOccupancy * 100).toFixed(0), onChange: (v) => ops.patchServiceTeam(ti, ["triggerOccupancy"], v / 100) }),
              /* @__PURE__ */ jsx18(NumField, { label: "Max hours", unit: "/wk", value: t.maxHoursPerWeek, onChange: (v) => ops.patchServiceTeam(ti, ["maxHoursPerWeek"], v) }),
              /* @__PURE__ */ jsx18(NumField, { label: "Agent cost", unit: "/yr", value: t.agentCost, onChange: (v) => ops.patchServiceTeam(ti, ["agentCost"], v) })
            ] }),
            /* @__PURE__ */ jsxs18("div", { children: [
              /* @__PURE__ */ jsx18("div", { className: "lab", style: { marginBottom: 6 }, children: "Covers queues" }),
              /* @__PURE__ */ jsx18("div", { className: "rowflex", children: config.queues.map((q) => /* @__PURE__ */ jsxs18("label", { className: "switch", children: [
                /* @__PURE__ */ jsx18(
                  "input",
                  {
                    type: "checkbox",
                ...
                /* @__PURE__ */ jsx18("span", { children: q.name })
              ] }, q.id)) })
            ] })
          ] })
        ] }, t.id)) })
...
function ViewsManager({ config, ops }) {
  ...
  return /* @__PURE__ */ jsxs19(
    Card,
    {
      ...
      right: /* @__PURE__ */ jsxs19("div", { className: "rowflex", children: [
        /* @__PURE__ */ jsx19("input", { type: "text", className: "inp", style: { width: 160 }, placeholder: "new view name", value: name, onChange: (e) => setName(e.target.value) }),
        /* @__PURE__ */ jsx19(
          "button",
          {
            type: "button",
      ...
      children: [
        /* @__PURE__ */ jsxs19("p", { className: "note", style: { marginBottom: 12 }, children: [
          '"Save enabled as view" captures the ',
          enabledIds.length,
          " currently-enabled scenario(s) as a reusable named combination."
        ] }),
        /* @__PURE__ */ jsx19("div", { className: "rows", children: config.views.map((v) => {
          const ids = viewIdsFor(config, v.id);
          const editable = !v.builtin && Array.isArray(v.scenarioIds);
          return /* @__PURE__ */ jsxs19("div", { className: "erow", children: [
            /* @__PURE__ */ jsxs19("div", { className: "erow-h", children: [
              v.builtin ? /* @__PURE__ */ jsx19("span", { className: "pill", children: "built-in" }) : /* @__PURE__ */ jsx19("span", { className: "tag soft", children: "saved" }),
              ...
              ) : /* @__PURE__ */ jsx19("strong", { children: v.name }),
              /* @__PURE__ */ jsxs19("span", { className: "pill", children: [
                ids.length,
                " scenario(s)"
              ] }),
              /* @__PURE__ */ jsx19("span", { className: "spacer" }),
              !v.builtin && /* @__PURE__ */ jsx19("button", { type: "button", className: "btn sm danger", onClick: () => ops.deleteView(v.id), children: "Delete" })
            ] }),
            /* @__PURE__ */ jsxs19("div", { className: "erow-b", children: [
              v.id === "v_por" && /* @__PURE__ */ jsxs19("p", { className: "note", children: [
                "Tracks the live enabled set \u2014 currently: ",
                enabledIds.length ? config.scenarios.filter((s) => s.enabled).map((s) => s.name).join(", ") : "none",
                "."
              ] }),
              v.id === "v_none" && /* @__PURE__ */ jsx19("p", { className: "note", children: "Always empty \u2014 the baseline with no scenarios applied." }),
              editable && /* @__PURE__ */ jsxs19("div", { className: "rowflex", children: [
                config.scenarios.map((s) => /* @__PURE__ */ jsxs19("label", { className: "switch", children: [
                  /* @__PURE__ */ jsx19(
                    "input",
                    {
                      type: "checkbox",
                  ...
                  /* @__PURE__ */ jsx19("span", { children: s.name })
                ] }, s.id)),
                config.scenarios.length === 0 && /* @__PURE__ */ jsx19("span", { className: "note", style: { padding: "6px 10px" }, children: "No scenarios to add." })
              ] })
            ] })
          ] }, v.id);
        }) })
...
function ScenarioParams({ s, ti, ops }) {
  ...
  switch (s.type) {
    case "growth":
      return /* @__PURE__ */ jsx20(NumField, { label: "Rate", unit: "%/mo", value: +(p.rate * 100).toFixed(1), onChange: (v) => set("rate", v / 100) });
    case "launch":
      return /* @__PURE__ */ jsxs20(Fragment6, { children: [
        /* @__PURE__ */ jsx20(NumField, { label: "Ramp", unit: "wk", value: p.ramp, onChange: (v) => set("ramp", v) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Peak uplift", unit: "%", value: +(p.peak * 100).toFixed(0), onChange: (v) => set("peak", v / 100) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Decay", unit: "wk", value: p.decay, onChange: (v) => set("decay", v) })
      ] });
    case "p1":
      return /* @__PURE__ */ jsxs20(Fragment6, { children: [
        /* @__PURE__ */ jsx20(NumField, { label: "Spike", unit: "%", value: +(p.spike * 100).toFixed(0), onChange: (v) => set("spike", v / 100) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Days", value: p.days, min: 1, max: 7, onChange: (v) => set("days", v) })
      ] });
    case "forecastError":
      return /* @__PURE__ */ jsx20(NumField, { label: "Error", unit: "%", value: +(p.error * 100).toFixed(0), onChange: (v) => set("error", v / 100) });
    case "attritionShock":
      return /* @__PURE__ */ jsx20(NumField, { label: "Added attrition", unit: "%/mo", value: +(p.add * 100).toFixed(1), onChange: (v) => set("add", v / 100) });
    case "hiringFreeze":
      return /* @__PURE__ */ jsx20(NumField, { label: "Duration", unit: "wk", value: p.weeks, onChange: (v) => set("weeks", v) });
    case "reducedTraining":
      return /* @__PURE__ */ jsxs20(Fragment6, { children: [
        /* @__PURE__ */ jsx20(NumField, { label: "Cut weeks", value: p.cutWeeks, onChange: (v) => set("cutWeeks", v) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Start prof.", unit: "%", value: +(p.startProficiency * 100).toFixed(0), onChange: (v) => set("startProficiency", v / 100) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Ramp stretch", unit: "\xD7", value: p.stretch, step: "0.05", onChange: (v) => set("stretch", v) }),
        /* @__PURE__ */ jsx20(NumField, { label: "AHT penalty", unit: "%", value: +(p.ahtPenalty * 100).toFixed(0), onChange: (v) => set("ahtPenalty", v / 100) }),
        /* @__PURE__ */ jsx20(NumField, { label: "Repeat uplift", unit: "%", value: +(p.repeatUplift * 100).toFixed(0), onChange: (v) => set("repeatUplift", v / 100) })
      ] });
    default:
      return null;
  }
...
function ScenariosEditor({ config, ops }) {
  return /* @__PURE__ */ jsxs20("div", { className: "grid", style: { gap: 14 }, children: [
    /* @__PURE__ */ jsxs20("div", { className: "btnbar", children: [
      ...
      /* @__PURE__ */ jsxs20("span", { className: "note", style: { padding: "6px 10px", alignSelf: "flex-end" }, children: [
    ...
    /* @__PURE__ */ jsxs20("div", { className: "rows", children: [
      config.scenarios.map((s, ti) => /* @__PURE__ */ jsxs20("div", { className: "erow", children: [
        /* @__PURE__ */ jsxs20("div", { className: "erow-h", children: [
          /* @__PURE__ */ jsx20(Toggle, { checked: s.enabled, onChange: (v) => ops.patchScenario(ti, ["enabled"], v) }),
          /* @__PURE__ */ jsx20("strong", { children: s.name }),
          /* @__PURE__ */ jsx20("span", { className: "pill", children: TYPE_LABELS[s.type] || s.type }),
          s.enabled && /* @__PURE__ */ jsx20("span", { className: "tag soft", children: "enabled" }),
          /* @__PURE__ */ jsx20("span", { className: "spacer" }),
          /* @__PURE__ */ jsx20("button", { type: "button", className: "btn sm danger", onClick: () => ops.deleteScenario(s.id), children: "Delete" })
        ] }),
        /* @__PURE__ */ jsxs20("div", { className: "erow-b", children: [
          /* @__PURE__ */ jsxs20("div", { className: "fieldrow", children: [
            /* @__PURE__ */ jsx20(TextField, { label: "Name", value: s.name, onChange: (v) => ops.patchScenario(ti, ["name"], v) }),
            /* @__PURE__ */ jsx20(NumField, { label: "Start week", value: s.startWeek + 1, min: 1, onChange: (v) => ops.patchScenario(ti, ["startWeek"], Math.max(0, v - 1)) }),
            /* @__PURE__ */ jsx20(
              SelectField,
              {
                label: "Applies to",
            ...
            /* @__PURE__ */ jsx20(ScenarioParams, { s, ti, ops })
          ] }),
          s.queueIds !== "all" && /* @__PURE__ */ jsx20("div", { className: "rowflex", children: config.queues.map((q) => /* @__PURE__ */ jsxs20("label", { className: "switch", children: [
            /* @__PURE__ */ jsx20(
              "input",
              {
                type: "checkbox",
      ...
      config.scenarios.length === 0 && /* @__PURE__ */ jsx20("div", { className: "empty", children: "No scenarios. Add one above." })
    ] }),
    /* @__PURE__ */ jsx20(ViewsManager, { config, ops })
  ] });
}
...
function MonthSliders({ months, onChange }) {
  return /* @__PURE__ */ jsx21("div", { className: "fieldrow", children: MONTHS.map((m, i) => /* @__PURE__ */ jsx21("div", { style: { width: 88 }, children: /* @__PURE__ */ jsx21(NumField, { label: m, value: +(months[i] * 100).toFixed(0), unit: "%", onChange: (v) => {
...
function SeasonalityEditor({ config, ops, seasonalityPresets, setSeasonalityPresets }) {
  ...
  return /* @__PURE__ */ jsxs21("div", { className: "grid", style: { gap: 14 }, children: [
    /* @__PURE__ */ jsxs21(Card, { title: "System-level seasonality", sub: "applies to every queue", hint: "Multiplier by calendar month, applied from the editable start month across the horizon.", children: [
      /* @__PURE__ */ jsx21("div", { className: "fieldrow", style: { maxWidth: 320, marginBottom: 12 }, children: /* @__PURE__ */ jsx21(
        SelectField,
        {
          label: "Start month",
      ...
      /* @__PURE__ */ jsx21(MonthSliders, { months: seas.system, onChange: (next) => ops.patch(["seasonality", "system"], next) })
    ] }),
    /* @__PURE__ */ jsx21("div", { className: "rows", children: config.queues.map((q) => {
      const hasOwn = Array.isArray(q.seasonal);
      return /* @__PURE__ */ jsxs21("details", { className: "erow", children: [
        /* @__PURE__ */ jsxs21("summary", { children: [
          /* @__PURE__ */ jsx21("span", { className: "chev", children: "\u25B6" }),
          /* @__PURE__ */ jsx21("strong", { children: q.name }),
          /* @__PURE__ */ jsx21("span", { className: "pill", children: hasOwn ? "queue overlay active" : "flat (system only)" })
        ] }),
        /* @__PURE__ */ jsxs21("div", { className: "erow-b", children: [
          /* @__PURE__ */ jsxs21("div", { className: "rowflex", children: [
            /* @__PURE__ */ jsx21(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsx21("span", { className: "note", style: { padding: "6px 10px" }, children: "Queue overlay multiplies on top of the system pattern above." })
          ] }),
          hasOwn && /* @__PURE__ */ jsxs21(Fragment7, { children: [
            /* @__PURE__ */ jsx21(
              PresetBar,
              {
                presets: seasonalityPresets,
            ...
            /* @__PURE__ */ jsx21(MonthSliders, { months: q.seasonal, onChange: (next) => ops.patchQueue(q.id, ["seasonal"], next) })
          ] })
        ] })
      ] }, q.id);
    }) })
...
// ui/App.jsx
import { Fragment as Fragment8, jsx as jsx22, jsxs as jsxs22 } from "react/jsx-runtime";
var TABS = [
  { id: "plan", label: "Plan" },
...
function App() {
  const [config, setConfig] = useState12(() => (0, import_engine8.makeDefaultConfig)());
  const [tab, setTab] = useState12("plan");
  const [intradayPresets, setIntradayPresets] = useState12(INTRADAY_PRESETS);
  const [seasonalityPresets, setSeasonalityPresets] = useState12(SEASONALITY_PRESETS);
  const ops = useConfigOps(setConfig);
  const [activeStrategy, setActiveStrategy] = useState12(() => config.hiring.activeStrategy || "S1");
  const [activeViewId, setActiveViewId] = useState12("v_por");
  const [comparison, setComparison] = useState12({ dimension: "strategies", overlayViewIds: ["v_por", "v_none"] });
  const storage = useMemo3(() => makeStorageAdapter(), []);
  const [savedRuns, setSavedRuns] = useState12([]);
  const [compareSel, setCompareSel] = useState12([]);
  const hydrated = useRef4(false);
  const loadRuns = useCallback3(async () => {
  ...
  const safeOverlay = useMemo3(() => comparison.overlayViewIds.filter((id) => viewIds.includes(id)), [comparison.overlayViewIds, viewIds.join(",")]);
  ...
  const saveRun = useCallback3(async (name) => {
    if (!activeSim) return;
  ...
  const deleteRun = useCallback3(async (r) => {
  ...
  const loadRunSettings = useCallback3((r) => {
    setConfig(r.config);
    setTab("plan");
  }, []);
  return /* @__PURE__ */ jsxs22("div", { className: "app", children: [
    /* @__PURE__ */ jsxs22("header", { className: "topbar", children: [
      /* @__PURE__ */ jsxs22("div", { className: "brand", children: [
        /* @__PURE__ */ jsx22("span", { className: "mark", children: "C" }),
        /* @__PURE__ */ jsx22("span", { children: "Capacity Simulator" }),
        /* @__PURE__ */ jsx22("small", { children: "call centre planning" })
      ] }),
      /* @__PURE__ */ jsx22("span", { className: "spacer" }),
      /* @__PURE__ */ jsxs22("div", { className: "topctrls", children: [
        /* @__PURE__ */ jsxs22("label", { className: "topctrl", children: [
          /* @__PURE__ */ jsx22("span", { children: "Strategy" }),
          /* @__PURE__ */ jsx22("select", { value: activeStrategy, onChange: (e) => setActiveStrategy(e.target.value), "aria-label": "Active strategy", children: STRATEGIES.map((s) => /* @__PURE__ */ jsxs22("option", { value: s.id, children: [
            s.id,
            " \xB7 ",
            s.name
          ] }, s.id)) })
        ...
        /* @__PURE__ */ jsxs22("label", { className: "topctrl", children: [
          /* @__PURE__ */ jsx22("span", { children: "View" }),
          /* @__PURE__ */ jsx22("select", { value: safeActiveView, onChange: (e) => setActiveViewId(e.target.value), "aria-label": "Active scenario view", children: config.views.map((v) => /* @__PURE__ */ jsx22("option", { value: v.id, children: v.name }, v.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs22("span", { className: "recalc" + (pending ? "" : " idle"), role: "status", "aria-live": "polite", children: [
        /* @__PURE__ */ jsx22("span", { className: "dot", "aria-hidden": "true" }),
        pending ? "Recalculating\u2026" : "Up to date"
      ] })
    ] }),
    /* @__PURE__ */ jsx22("nav", { className: "tabs", role: "tablist", "aria-label": "Sections", children: TABS.map((t) => /* @__PURE__ */ jsx22("button", { type: "button", role: "tab", id: "tab-" + t.id, "aria-selected": tab === t.id, "aria-controls": "panel-" + t.id, className: "tab", onClick: () => setTab(t.id), children: t.label }, t.id)) }),
    /* @__PURE__ */ jsx22("main", { className: "main", children: TABS.map((t) => /* @__PURE__ */ jsx22("div", { role: "tabpanel", id: "panel-" + t.id, "aria-labelledby": "tab-" + t.id, hidden: tab !== t.id, children: tab === t.id && /* @__PURE__ */ jsx22(
      TabBody,
      {
        id: t.id,
        simSet,
...
function TabBody(props) {
  ...
  switch (id) {
    case "plan":
      return /* @__PURE__ */ jsx22(PlanTab, { sim: activeSim, viewLabel: viewName(config, props.activeViewId) });
    case "intraday":
      return /* @__PURE__ */ jsx22(IntradayTab, { sim: activeSim });
    case "strategies":
      return /* @__PURE__ */ jsx22(StrategiesTab, { simSet, config, activeStrategy: props.activeStrategy, activeViewId: props.activeViewId, onActivateStrategy: props.onActivateStrategy, comparison: props.comparison, setComparison: props.setComparison });
    case "data":
      return /* @__PURE__ */ jsx22(DataTab, { sim: activeSim, config, activeViewId: props.activeViewId, views: config.views, onSelectView: props.onSelectView });
    case "summary":
      return /* @__PURE__ */ jsx22(SummaryTab, { sim: activeSim, strategySims: simSet.strategySims, config, activeStrategy: props.activeStrategy, activeViewId: props.activeViewId });
    case "report":
      return /* @__PURE__ */ jsxs22(Fragment8, { children: [
        /* @__PURE__ */ jsx22(ReportTab, { sim: activeSim, strategySims: simSet.strategySims, config, activeStrategy: props.activeStrategy, activeViewId: props.activeViewId }),
        /* @__PURE__ */ jsx22("div", { style: { marginTop: 16 }, children: /* @__PURE__ */ jsx22(FilesCard, { sim: activeSim, strategySims: simSet.strategySims, config, activeStrategy: props.activeStrategy, activeViewId: props.activeViewId, onImportConfig: props.onImportConfig }) })
      ] });
    case "runs":
      return /* @__PURE__ */ jsx22(
        RunsTab,
        {
          ...
          config,
          onSave: props.onSaveRun,
          onDelete: props.onDeleteRun,
          onLoadSettings: props.onLoadRunSettings,
          onRefresh: props.onRefreshRuns
        }
      );
    case "notes":
      return /* @__PURE__ */ jsx22(NotesTab, {});
    case "queues":
      return /* @__PURE__ */ jsx22(QueuesEditor, { config, ops, intradayPresets: props.intradayPresets, setIntradayPresets: props.setIntradayPresets });
    case "workforce":
      return /* @__PURE__ */ jsx22(WorkforceEditor, { config, ops });
    case "money":
      return /* @__PURE__ */ jsx22(MoneyEditor, { config, ops });
    case "scenarios":
      return /* @__PURE__ */ jsx22(ScenariosEditor, { config, ops });
    case "seasonality":
      return /* @__PURE__ */ jsx22(SeasonalityEditor, { config, ops, seasonalityPresets: props.seasonalityPresets, setSeasonalityPresets: props.setSeasonalityPresets });
    default:
      return null;
  }
}
...
function mount(container) {
  ...
  root.render(/* @__PURE__ */ jsx23(App, {}));
  return root;
}
